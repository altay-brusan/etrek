...
#include "ScanProtocolUtil.h"
    ...
    public:
        ...
        QString ImageProcessingAlgorithm; ///< Recommended algorithm (`image_processing_algorithm`).

        bool ImageHorizontalFlip = false; ///< UI hint: mirror image horizontally (`image_horizontal_flip`).
        ...
        /// Positioner linkage by name (FK by `position_name`). Stored as plain string to avoid circular deps.
