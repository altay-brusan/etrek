...
\hypertarget{_sparse_l_u__column__bmod_8h_source}{}\label{_sparse_l_u__column__bmod_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_column\_bmod.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_column\_bmod.h}}
...
\DoxyCodeLine{00053\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_ae34275602cf12560edfcaf7cd5cbe932}{SparseLUImpl<Scalar,StorageIndex>::column\_bmod}}(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jcol,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nseg,\ BlockScalarVector\ dense,\ ScalarVector\&\ tempv,}
\DoxyCodeLine{00054\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ BlockIndexVector\ segrep,\ BlockIndexVector\ repfnz,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ fpanelc,\ GlobalLU\_t\&\ glu)}
\DoxyCodeLine{00055\ \{}
\DoxyCodeLine{00056\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \ jsupno,\ k,\ ksub,\ krep,\ ksupno;\ }
\DoxyCodeLine{00057\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lptr,\ nrow,\ isub,\ irow,\ nextlu,\ new\_next,\ ufirst;\ }
\DoxyCodeLine{00058\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ fsupc,\ nsupc,\ nsupr,\ luptr,\ kfnz,\ no\_zeros;\ }
...
\DoxyCodeLine{00071\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ d\_fsupc;\ \textcolor{comment}{//\ distance\ between\ the\ first\ column\ of\ the\ current\ panel\ and\ the\ }}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ first\ column\ of\ the\ current\ snode}}
\DoxyCodeLine{00073\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ fst\_col;\ \textcolor{comment}{//\ First\ column\ within\ small\ LU\ update}}
\DoxyCodeLine{00074\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ segsize;\ }
...
\DoxyCodeLine{00099\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lda\ =\ glu.xlusup(fst\_col+1)\ -\/\ glu.xlusup(fst\_col);}
\DoxyCodeLine{00100\ \ \ \ \ \ \ }
\DoxyCodeLine{00101\ \ \ \ \ \ \ }
...
\DoxyCodeLine{00117\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ mem;\ }
\DoxyCodeLine{00118\ \ \ new\_next\ =\ nextlu\ +\ glu.xlsub(fsupc\ +\ 1)\ -\/\ glu.xlsub(fsupc);\ }
\DoxyCodeLine{00119\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ offset\ =\ internal::first\_multiple<Index>(new\_next,\ internal::packet\_traits<Scalar>::size)\ -\/\ new\_next;}
...
\DoxyCodeLine{00123\ \ \ \{}
\DoxyCodeLine{00124\ \ \ \ \ mem\ =\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_a2a6465f1173fd8b74b2e5b8ceec53343}{memXpand<ScalarVector>}}(glu.lusup,\ glu.nzlumax,\ nextlu,\ LUSUP,\ glu.num\_expansions);\ \ }
...
\DoxyCodeLine{00132\ \ \ \ \ dense(irow)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}(0.0);\ }
...
\DoxyCodeLine{00140\ \ \ \}}
\DoxyCodeLine{00141\ \ \ glu.xlusup(jcol\ +\ 1)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(nextlu);\ \ \textcolor{comment}{//\ close\ L\(\backslash\)U(*,jcol);\ }}
\DoxyCodeLine{00142\ \ \ }
...
\DoxyCodeLine{00165\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lda\ =\ glu.xlusup(jcol+1)\ -\/\ glu.xlusup(jcol);}
\DoxyCodeLine{00166\ \ \ \ \ MappedMatrixBlock\ A(\ \&(glu.lusup.data()[luptr]),\ nsupc,\ nsupc,\ \doxymbox{\hyperlink{class_eigen_1_1_outer_stride}{OuterStride<>}}(lda)\ );}
\DoxyCodeLine{00167\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_vector_block}{VectorBlock<ScalarVector>}}\ u(glu.lusup,\ ufirst,\ nsupc);\ }
\DoxyCodeLine{00168\ \ \ \ \ u\ =\ A.template\ triangularView<UnitLower>().solve(u);\ }
\DoxyCodeLine{00169\ \ \ \ \ }
\DoxyCodeLine{00170\ \ \ \ \ \textcolor{keyword}{new}\ (\&A)\ MappedMatrixBlock\ (\ \&(glu.lusup.data()[luptr+nsupc]),\ nrow,\ nsupc,\ \doxymbox{\hyperlink{class_eigen_1_1_outer_stride}{OuterStride<>}}(lda)\ );}
\DoxyCodeLine{00171\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_vector_block}{VectorBlock<ScalarVector>}}\ l(glu.lusup,\ ufirst+nsupc,\ nrow);\ }
