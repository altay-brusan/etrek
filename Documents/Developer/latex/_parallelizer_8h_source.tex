...
\hypertarget{_parallelizer_8h_source}{}\label{_parallelizer_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/products/Parallelizer.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/products/Parallelizer.h}}
...
\DoxyCodeLine{00050\ \}}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00053\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{namespace_eigen_a820c0e0460934cc17eb6dacbad54a9f5}{initParallel}}()}
\DoxyCodeLine{00054\ \{}
...
\DoxyCodeLine{00059\ \}}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00063\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \doxymbox{\hyperlink{namespace_eigen_a9aca97d83e21b91a04ec079360dfffeb}{nbThreads}}()}
\DoxyCodeLine{00064\ \{}
...
\DoxyCodeLine{00068\ \}}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00072\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{namespace_eigen_af9cd17c2fe18204239cd11c88c120b50}{setNbThreads}}(\textcolor{keywordtype}{int}\ v)}
\DoxyCodeLine{00073\ \{}
...
\DoxyCodeLine{00091\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \textcolor{keyword}{volatile}\ sync;}
...
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lhs\_start;}
\DoxyCodeLine{00096\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lhs\_length;}
\DoxyCodeLine{00097\ \};}
\DoxyCodeLine{00098\ }
...
\DoxyCodeLine{00100\ \textcolor{keywordtype}{void}\ parallelize\_gemm(\textcolor{keyword}{const}\ Functor\&\ func,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ depth,\ \textcolor{keywordtype}{bool}\ transpose)}
\DoxyCodeLine{00101\ \{}
...
\DoxyCodeLine{00125\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ size\ =\ transpose\ ?\ rows\ :\ cols;}
\DoxyCodeLine{00126\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pb\_max\_threads\ =\ std::max<Index>(1,size\ /\ Functor::Traits::nr);}
\DoxyCodeLine{00127\ }
...
\DoxyCodeLine{00132\ \ \ pb\_max\_threads\ =\ std::max<Index>(1,\ std::min<Index>(pb\_max\_threads,\ \textcolor{keyword}{static\_cast<}\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\textcolor{keyword}{>}(\ work\ /\ kMinTaskSize\ )\ ));}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \textcolor{comment}{//\ compute\ the\ number\ of\ threads\ we\ are\ going\ to\ use}}
\DoxyCodeLine{00135\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ threads\ =\ std::min<Index>(\doxymbox{\hyperlink{namespace_eigen_a9aca97d83e21b91a04ec079360dfffeb}{nbThreads}}(),\ pb\_max\_threads);}
\DoxyCodeLine{00136\ }
...
\DoxyCodeLine{00142\ }
\DoxyCodeLine{00143\ \ \ \doxymbox{\hyperlink{namespace_eigen_a820c0e0460934cc17eb6dacbad54a9f5}{Eigen::initParallel}}();}
...
\DoxyCodeLine{00148\ }
\DoxyCodeLine{00149\ \ \ ei\_declare\_aligned\_stack\_constructed\_variable(\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1_gemm_parallel_info}{GemmParallelInfo<Index>}},info,threads,0);}
\DoxyCodeLine{00150\ }
\DoxyCodeLine{00151\ \textcolor{preprocessor}{\ \ \#pragma\ omp\ parallel\ num\_threads(threads)}}
\DoxyCodeLine{00152\ \ \ \{}
\DoxyCodeLine{00153\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ omp\_get\_thread\_num();}
...
\DoxyCodeLine{00155\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actual\_threads\ =\ omp\_get\_num\_threads();}
\DoxyCodeLine{00156\ }
\DoxyCodeLine{00157\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ blockCols\ =\ (cols\ /\ actual\_threads)\ \&\ \string~\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}(0x3);}
\DoxyCodeLine{00158\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ blockRows\ =\ (rows\ /\ actual\_threads);}
\DoxyCodeLine{00159\ \ \ \ \ blockRows\ =\ (blockRows/Functor::Traits::mr)*Functor::Traits::mr;}
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ r0\ =\ i*blockRows;}
\DoxyCodeLine{00162\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actualBlockRows\ =\ (i+1==actual\_threads)\ ?\ rows-\/r0\ :\ blockRows;}
\DoxyCodeLine{00163\ }
\DoxyCodeLine{00164\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ c0\ =\ i*blockCols;}
\DoxyCodeLine{00165\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actualBlockCols\ =\ (i+1==actual\_threads)\ ?\ cols-\/c0\ :\ blockCols;}
\DoxyCodeLine{00166\ }
