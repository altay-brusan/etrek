...
\hypertarget{_sparse_l_u__heap__relax__snode_8h_source}{}\label{_sparse_l_u__heap__relax__snode_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_heap\_relax\_snode.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_heap\_relax\_snode.h}}
...
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
...
\DoxyCodeLine{00046\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_a88952ce33c968374b149e31d0539178d}{SparseLUImpl<Scalar,StorageIndex>::heap\_relax\_snode}}\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n,\ IndexVector\&\ et,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ relax\_columns,\ IndexVector\&\ descendants,\ IndexVector\&\ relax\_end)}
\DoxyCodeLine{00047\ \{}
\DoxyCodeLine{00048\ \ \ }
...
\DoxyCodeLine{00051\ \ \ internal::treePostorder(\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(n),\ et,\ post);\ \textcolor{comment}{//\ Post\ order\ etree}}
\DoxyCodeLine{00052\ \ \ IndexVector\ inv\_post(n+1);\ }
\DoxyCodeLine{00053\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ i\ =\ 0;\ i\ <\ n+1;\ ++i)\ inv\_post(post(i))\ =\ i;\ \textcolor{comment}{//\ inv\_post\ =\ post.inverse()???}}
\DoxyCodeLine{00054\ \ \ }
...
\DoxyCodeLine{00066\ \ \ relax\_end.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(emptyIdxLU);}
\DoxyCodeLine{00067\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j,\ parent;\ }
\DoxyCodeLine{00068\ \ \ descendants.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac21ad5f989f320e46958b75ac8d9a1da}{setZero}}();}
...
\DoxyCodeLine{00076\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ snode\_start;\ \textcolor{comment}{//\ beginning\ of\ a\ snode\ }}
\DoxyCodeLine{00077\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ k;}
\DoxyCodeLine{00078\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nsuper\_et\_post\ =\ 0;\ \textcolor{comment}{//\ Number\ of\ relaxed\ snodes\ in\ postordered\ etree\ }}
\DoxyCodeLine{00079\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nsuper\_et\ =\ 0;\ \textcolor{comment}{//\ Number\ of\ relaxed\ snodes\ in\ the\ original\ etree\ }}
\DoxyCodeLine{00080\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ l;\ }
...
\DoxyCodeLine{00092\ \ \ \ \ k\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(n);}
\DoxyCodeLine{00093\ \ \ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ snode\_start;\ i\ <=\ j;\ ++i)}
...
\DoxyCodeLine{00103\ \ \ \ \ \{}
\DoxyCodeLine{00104\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ snode\_start;\ i\ <=\ j;\ ++i)\ }
\DoxyCodeLine{00105\ \ \ \ \ \ \ \{}
