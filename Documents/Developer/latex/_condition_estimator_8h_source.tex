...
\hypertarget{_condition_estimator_8h_source}{}\label{_condition_estimator_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/ConditionEstimator.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/ConditionEstimator.h}}
...
\DoxyCodeLine{00018\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1rcond__compute__sign}{rcond\_compute\_sign}}\ \{}
...
\DoxyCodeLine{00028\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1rcond__compute__sign}{rcond\_compute\_sign}}<Vector,\ Vector,\ false>\ \{}
...
\DoxyCodeLine{00057\ \{}
\DoxyCodeLine{00058\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Decomposition::MatrixType\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{MatrixType}};}
\DoxyCodeLine{00059\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Decomposition::Scalar\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}};}
...
\DoxyCodeLine{00066\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ dec.rows();}
...
\DoxyCodeLine{00075\ \ \ Vector\ v\ =\ dec.solve(Vector::Ones(n)\ /\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}(n));}
...
\DoxyCodeLine{00094\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ v\_max\_abs\_index\ =\ -\/1;}
\DoxyCodeLine{00095\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ old\_v\_max\_abs\_index\ =\ v\_max\_abs\_index;}
...
\DoxyCodeLine{00133\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}\ alternating\_sign(RealScalar(1));}
\DoxyCodeLine{00134\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ 0;\ i\ <\ n;\ ++i)\ \{}
