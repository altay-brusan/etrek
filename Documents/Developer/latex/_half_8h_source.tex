\doxysection{Half.\+h}
\hypertarget{_half_8h_source}{}\label{_half_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/arch/Default/Half.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/arch/Default/Half.h}}
...
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00060\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1half}{half}};}
\DoxyCodeLine{00063\ }
...
\DoxyCodeLine{00087\ \textcolor{keyword}{struct\ }\_\_half\_raw\ \{}
...
\DoxyCodeLine{00094\ \ \ EIGEN\_DEVICE\_FUNC\ \_\_half\_raw()\ \{\}}
\DoxyCodeLine{00095\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00096\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \_\_half\_raw()\ :\ x(0)\ \{\}}
...
\DoxyCodeLine{00099\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \_\_half\_raw(numext::uint16\_t\ raw)\ :\ x(numext::bit\_cast<\_\_fp16>(raw))\ \{}
\DoxyCodeLine{00100\ \ \ \}}
\DoxyCodeLine{00101\ \ \ \_\_fp16\ x;}
\DoxyCodeLine{00102\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00103\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \_\_half\_raw(numext::uint16\_t\ raw)\ :\ x(raw)\ \{\}}
...
\DoxyCodeLine{00114\ \ \ \ \ \textcolor{keyword}{typedef}\ \_\_half\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}};}
...
\DoxyCodeLine{00117\ \ \ \textcolor{keyword}{typedef}\ cl::sycl::half\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}};}
\DoxyCodeLine{00118\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00120\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ raw\_uint16\_to\_half(numext::uint16\_t\ x);}
\DoxyCodeLine{00121\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ float\_to\_half\_rtne(\textcolor{keywordtype}{float}\ ff);}
\DoxyCodeLine{00122\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ \textcolor{keywordtype}{float}\ half\_to\_float(\doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}});}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \textcolor{keyword}{struct\ }half\_base\ :\ \textcolor{keyword}{public}\ \_\_half\_raw\ \{}
\DoxyCodeLine{00125\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half\_base()\ \{\}}
\DoxyCodeLine{00126\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half\_base(\textcolor{keyword}{const}\ \_\_half\_raw\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ :\ \_\_half\_raw(\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{\}}
\DoxyCodeLine{00127\ }
...
\DoxyCodeLine{00130\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half\_base(\textcolor{keyword}{const}\ \_\_half\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{\ x\ =\ \_\_half\_as\_ushort(\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}});\ \}}
...
\DoxyCodeLine{00133\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half\_base(\textcolor{keyword}{const}\ \_\_half\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ :\ \_\_half\_raw(*(\_\_half\_raw*)\&\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{\}}
...
\DoxyCodeLine{00142\ \textcolor{keyword}{struct\ }half\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}\ \{}
\DoxyCodeLine{00143\ }
...
\DoxyCodeLine{00150\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{half\_impl::\_\_half\_raw}}\ \_\_half\_raw;}
...
\DoxyCodeLine{00159\ \ \ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{half\_impl::\_\_half\_raw}}\ \_\_half\_raw;}
\DoxyCodeLine{00160\ \textcolor{preprocessor}{\ \ \#endif}}
\DoxyCodeLine{00161\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00162\ }
\DoxyCodeLine{00163\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half()\ \{\}}
\DoxyCodeLine{00164\ }
\DoxyCodeLine{00165\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half(\textcolor{keyword}{const}\ \_\_half\_raw\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{\}}
\DoxyCodeLine{00166\ }
...
\DoxyCodeLine{00169\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half(\textcolor{keyword}{const}\ \_\_half\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{\}}
...
\DoxyCodeLine{00176\ }
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ half(\textcolor{keywordtype}{bool}\ b)}
\DoxyCodeLine{00179\ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(half\_impl::raw\_uint16\_to\_half(b\ ?\ 0x3c00\ :\ 0))\ \{\}}
\DoxyCodeLine{00180\ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00181\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ half(T\ val)}
\DoxyCodeLine{00182\ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(half\_impl::float\_to\_half\_rtne(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{float}\textcolor{keyword}{>}(val)))\ \{\}}
\DoxyCodeLine{00183\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ half(\textcolor{keywordtype}{float}\ f)}
\DoxyCodeLine{00184\ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(half\_impl::float\_to\_half\_rtne(f))\ \{\}}
\DoxyCodeLine{00185\ }
...
\DoxyCodeLine{00189\ \ \ \textcolor{keyword}{explicit}\ EIGEN\_DEVICE\_FUNC\ half(std::complex<RealScalar>\ c)}
\DoxyCodeLine{00190\ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1half__base}{half\_impl::half\_base}}(half\_impl::float\_to\_half\_rtne(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{float}\textcolor{keyword}{>}(c.real())))\ \{\}}
\DoxyCodeLine{00191\ }
\DoxyCodeLine{00192\ \ \ \ EIGEN\_DEVICE\_FUNC\ \textcolor{keyword}{operator}\ float()\textcolor{keyword}{\ const\ }\{\ \ \textcolor{comment}{//\ NOLINT:\ Allow\ implicit\ conversion\ to\ float,\ because\ it\ is\ lossless.}}
...
\DoxyCodeLine{00197\ \ \ EIGEN\_DEVICE\_FUNC\ \textcolor{keyword}{operator}\ \_\_half()\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00198\ \ \ \ \ ::\_\_half\_raw\ hr;}
\DoxyCodeLine{00199\ \ \ \ \ hr.x\ =\ x;}
...
\DoxyCodeLine{00209\ \textcolor{keyword}{struct\ }numeric\_limits<\doxymbox{\hyperlink{namespace_eigen}{Eigen}}::half>\ \{}
...
\DoxyCodeLine{00233\ }
\DoxyCodeLine{00234\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ (min)()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x400);\ \}}
\DoxyCodeLine{00235\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ lowest()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0xfbff);\ \}}
\DoxyCodeLine{00236\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ (max)()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x7bff);\ \}}
\DoxyCodeLine{00237\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ epsilon()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x0800);\ \}}
\DoxyCodeLine{00238\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ round\_error()\ \{\ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}(0.5);\ \}}
\DoxyCodeLine{00239\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ infinity()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x7c00);\ \}}
\DoxyCodeLine{00240\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ quiet\_NaN()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x7e00);\ \}}
\DoxyCodeLine{00241\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ signaling\_NaN()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x7d00);\ \}}
\DoxyCodeLine{00242\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ denorm\_min()\ \{\ \textcolor{keywordflow}{return}\ Eigen::half\_impl::raw\_uint16\_to\_half(0x1);\ \}}
\DoxyCodeLine{00243\ \};}
\DoxyCodeLine{00244\ }
...
\DoxyCodeLine{00250\ \textcolor{keyword}{struct\ }numeric\_limits<const\ \doxymbox{\hyperlink{namespace_eigen}{Eigen}}::half>\ :\ numeric\_limits<Eigen::half>\ \{\};}
\DoxyCodeLine{00251\ \textcolor{keyword}{template}<>}
\DoxyCodeLine{00252\ \textcolor{keyword}{struct\ }numeric\_limits<volatile\ \doxymbox{\hyperlink{namespace_eigen}{Eigen}}::half>\ :\ numeric\_limits<Eigen::half>\ \{\};}
\DoxyCodeLine{00253\ \textcolor{keyword}{template}<>}
\DoxyCodeLine{00254\ \textcolor{keyword}{struct\ }numeric\_limits<const\ volatile\ \doxymbox{\hyperlink{namespace_eigen}{Eigen}}::half>\ :\ numeric\_limits<Eigen::half>\ \{\};}
\DoxyCodeLine{00255\ \}\ \textcolor{comment}{//\ end\ namespace\ std}}
\DoxyCodeLine{00256\ }
\DoxyCodeLine{00257\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
\DoxyCodeLine{00258\ }
...
\DoxyCodeLine{00464\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ half\ operator\ /\ (\textcolor{keyword}{const}\ half\&\ a,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ b)\ \{}
...
\DoxyCodeLine{00494\ }
\DoxyCodeLine{00495\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ raw\_uint16\_to\_half(numext::uint16\_t\ x)\ \{}
...
\DoxyCodeLine{00503\ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ h;}
\DoxyCodeLine{00504\ \ \ \ h.x\ =\ x;}
\DoxyCodeLine{00505\ \ \ \textcolor{keywordflow}{return}\ h;}
\DoxyCodeLine{00506\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00507\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}(x);}
\DoxyCodeLine{00508\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00509\ \}}
\DoxyCodeLine{00510\ }
\DoxyCodeLine{00511\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ numext::uint16\_t\ raw\_half\_as\_uint16(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\&\ h)\ \{}
...
\DoxyCodeLine{00522\ \}}
\DoxyCodeLine{00523\ }
\DoxyCodeLine{00524\ \textcolor{keyword}{union\ }\doxymbox{\hyperlink{union_eigen_1_1half__impl_1_1float32__bits}{float32\_bits}}\ \{}
...
\DoxyCodeLine{00527\ \};}
\DoxyCodeLine{00528\ }
\DoxyCodeLine{00529\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ float\_to\_half\_rtne(\textcolor{keywordtype}{float}\ ff)\ \{}
...
\DoxyCodeLine{00533\ \ \ \textcolor{keywordflow}{return}\ *(\doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}*)\&tmp\_ff;}
\DoxyCodeLine{00534\ }
\DoxyCodeLine{00535\ \textcolor{preprocessor}{\#elif\ defined(EIGEN\_HAS\_FP16\_C)}}
\DoxyCodeLine{00536\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}};}
\DoxyCodeLine{00537\ \ \ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}.x\ =\ \_cvtss\_sh(ff,\ 0);}
\DoxyCodeLine{00538\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}};}
\DoxyCodeLine{00539\ }
\DoxyCodeLine{00540\ \textcolor{preprocessor}{\#elif\ defined(EIGEN\_HAS\_ARM64\_FP16\_SCALAR\_ARITHMETIC)}}
\DoxyCodeLine{00541\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}};}
\DoxyCodeLine{00542\ \ \ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}.x\ =\ \textcolor{keyword}{static\_cast<}\_\_fp16\textcolor{keyword}{>}(ff);}
\DoxyCodeLine{00543\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}};}
\DoxyCodeLine{00544\ }
\DoxyCodeLine{00545\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00546\ \ \ \doxymbox{\hyperlink{union_eigen_1_1half__impl_1_1float32__bits}{float32\_bits}}\ f;\ f.f\ =\ ff;}
\DoxyCodeLine{00547\ }
\DoxyCodeLine{00548\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{union_eigen_1_1half__impl_1_1float32__bits}{float32\_bits}}\ f32infty\ =\ \{\ 255\ <<\ 23\ \};}
\DoxyCodeLine{00549\ \ \ \textcolor{keyword}{const}\ float32\_bits\ f16max\ =\ \{\ (127\ +\ 16)\ <<\ 23\ \};}
...
\DoxyCodeLine{00552\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ o;}
...
\DoxyCodeLine{00591\ \}}
\DoxyCodeLine{00592\ }
\DoxyCodeLine{00593\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ \textcolor{keywordtype}{float}\ half\_to\_float(\doxymbox{\hyperlink{struct_eigen_1_1half__impl_1_1____half__raw}{\_\_half\_raw}}\ h)\ \{}
...
\DoxyCodeLine{00602\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{union_eigen_1_1half__impl_1_1float32__bits}{float32\_bits}}\ magic\ =\ \{\ 113\ <<\ 23\ \};}
...
\DoxyCodeLine{00604\ \ \ \doxymbox{\hyperlink{union_eigen_1_1half__impl_1_1float32__bits}{float32\_bits}}\ o;}
\DoxyCodeLine{00605\ }
...
\DoxyCodeLine{00775\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1random__default__impl}{random\_default\_impl}}<\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}},\ false,\ false>}
\DoxyCodeLine{00776\ \{}
\DoxyCodeLine{00777\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}\ run(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}\&\ x,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}\&\ y)}
\DoxyCodeLine{00778\ \ \ \{}
\DoxyCodeLine{00779\ \ \ \ \ \textcolor{keywordflow}{return}\ x\ +\ (y-\/x)\ *\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}(\textcolor{keywordtype}{float}(std::rand())\ /\ \textcolor{keywordtype}{float}(RAND\_MAX));}
\DoxyCodeLine{00780\ \ \ \}}
\DoxyCodeLine{00781\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}\ run()}
\DoxyCodeLine{00782\ \ \ \{}
\DoxyCodeLine{00783\ \ \ \ \ \textcolor{keywordflow}{return}\ run(\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}(-\/1.f),\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}(1.f));}
\DoxyCodeLine{00784\ \ \ \}}
\DoxyCodeLine{00785\ \};}
\DoxyCodeLine{00786\ }
\DoxyCodeLine{00787\ \textcolor{keyword}{template}<>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1is__arithmetic}{is\_arithmetic}}<\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1unpacket__traits}{half}}>\ \{\ \textcolor{keyword}{enum}\ \{\ value\ =\ \textcolor{keyword}{true}\ \};\ \};}
\DoxyCodeLine{00788\ }
\DoxyCodeLine{00789\ \}\ \textcolor{comment}{//\ end\ namespace\ internal}}
\DoxyCodeLine{00790\ }
\DoxyCodeLine{00791\ \textcolor{keyword}{template}<>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{NumTraits}}<\doxymbox{\hyperlink{namespace_eigen}{Eigen}}::\doxymbox{\hyperlink{struct_eigen_1_1half}{half}}>}
\DoxyCodeLine{00792\ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1_generic_num_traits}{GenericNumTraits}}<Eigen::half>}
\DoxyCodeLine{00793\ \{}
...
\DoxyCodeLine{00799\ \ \ \};}
\DoxyCodeLine{00800\ }
\DoxyCodeLine{00801\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ epsilon()\ \{}
\DoxyCodeLine{00802\ \ \ \ \ \textcolor{keywordflow}{return}\ half\_impl::raw\_uint16\_to\_half(0x0800);}
\DoxyCodeLine{00803\ \ \ \}}
\DoxyCodeLine{00804\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ dummy\_precision()\ \{}
\DoxyCodeLine{00805\ \ \ \ \ \textcolor{keywordflow}{return}\ half\_impl::raw\_uint16\_to\_half(0x211f);\ \textcolor{comment}{//\ \ Eigen::half(1e-\/2f);}}
\DoxyCodeLine{00806\ \ \ \}}
\DoxyCodeLine{00807\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ highest()\ \{}
\DoxyCodeLine{00808\ \ \ \ \ \textcolor{keywordflow}{return}\ half\_impl::raw\_uint16\_to\_half(0x7bff);}
\DoxyCodeLine{00809\ \ \ \}}
\DoxyCodeLine{00810\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ lowest()\ \{}
\DoxyCodeLine{00811\ \ \ \ \ \textcolor{keywordflow}{return}\ half\_impl::raw\_uint16\_to\_half(0xfbff);}
\DoxyCodeLine{00812\ \ \ \}}
\DoxyCodeLine{00813\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ infinity()\ \{}
\DoxyCodeLine{00814\ \ \ \ \ \textcolor{keywordflow}{return}\ half\_impl::raw\_uint16\_to\_half(0x7c00);}
\DoxyCodeLine{00815\ \ \ \}}
\DoxyCodeLine{00816\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_CONSTEXPR\ \textcolor{keyword}{static}\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ quiet\_NaN()\ \{}
...
\DoxyCodeLine{00826\ }
\DoxyCodeLine{00827\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
...
\DoxyCodeLine{00833\ EIGEN\_DEVICE\_FUNC\ EIGEN\_ALWAYS\_INLINE\ bool(isnan)(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\&\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}})\ \{}
\DoxyCodeLine{00834\ \ \ \textcolor{keywordflow}{return}\ (half\_impl::isnan)(\doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}});}
\DoxyCodeLine{00835\ \}}
\DoxyCodeLine{00836\ }
\DoxyCodeLine{00837\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00838\ EIGEN\_DEVICE\_FUNC\ EIGEN\_ALWAYS\_INLINE\ bool(isinf)(\textcolor{keyword}{const}\ Eigen::half\&\ h)\ \{}
\DoxyCodeLine{00839\ \ \ \textcolor{keywordflow}{return}\ (half\_impl::isinf)(h);}
\DoxyCodeLine{00840\ \}}
\DoxyCodeLine{00841\ }
\DoxyCodeLine{00842\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00843\ EIGEN\_DEVICE\_FUNC\ EIGEN\_ALWAYS\_INLINE\ bool(isfinite)(\textcolor{keyword}{const}\ Eigen::half\&\ h)\ \{}
...
\DoxyCodeLine{00850\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ Eigen::half\ bit\_cast<Eigen::half,\ uint16\_t>(\textcolor{keyword}{const}\ uint16\_t\&\ src)\ \{}
\DoxyCodeLine{00851\ \ \ \textcolor{keywordflow}{return}\ Eigen::half(Eigen::half\_impl::raw\_uint16\_to\_half(src));}
\DoxyCodeLine{00852\ \}}
\DoxyCodeLine{00853\ }
\DoxyCodeLine{00854\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00855\ EIGEN\_STRONG\_INLINE\ EIGEN\_DEVICE\_FUNC\ uint16\_t\ bit\_cast<uint16\_t,\ Eigen::half>(\textcolor{keyword}{const}\ Eigen::half\&\ src)\ \{}
...
\DoxyCodeLine{00877\ }
\DoxyCodeLine{00878\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_sync(\textcolor{keywordtype}{unsigned}\ mask,\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{int}\ srcLane,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
\DoxyCodeLine{00879\ \ \ \textcolor{keyword}{const}\ \_\_half\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}\ =\ var;}
\DoxyCodeLine{00880\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\textcolor{keyword}{>}(\_\_shfl\_sync(mask,\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}},\ srcLane,\ width));}
\DoxyCodeLine{00881\ \}}
\DoxyCodeLine{00882\ }
\DoxyCodeLine{00883\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_up\_sync(\textcolor{keywordtype}{unsigned}\ mask,\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ delta,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
\DoxyCodeLine{00884\ \ \ \textcolor{keyword}{const}\ \_\_half\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}\ =\ var;}
\DoxyCodeLine{00885\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\textcolor{keyword}{>}(\_\_shfl\_up\_sync(mask,\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}},\ delta,\ width));}
\DoxyCodeLine{00886\ \}}
\DoxyCodeLine{00887\ }
\DoxyCodeLine{00888\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_down\_sync(\textcolor{keywordtype}{unsigned}\ mask,\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ delta,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
\DoxyCodeLine{00889\ \ \ \textcolor{keyword}{const}\ \_\_half\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}\ =\ var;}
\DoxyCodeLine{00890\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\textcolor{keyword}{>}(\_\_shfl\_down\_sync(mask,\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}},\ delta,\ width));}
\DoxyCodeLine{00891\ \}}
\DoxyCodeLine{00892\ }
\DoxyCodeLine{00893\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_xor\_sync(\textcolor{keywordtype}{unsigned}\ mask,\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{int}\ laneMask,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
\DoxyCodeLine{00894\ \ \ \textcolor{keyword}{const}\ \_\_half\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}}\ =\ var;}
\DoxyCodeLine{00895\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\textcolor{keyword}{>}(\_\_shfl\_xor\_sync(mask,\ \doxymbox{\hyperlink{classvtk_en_sight_gold_combined_reader_1_1h}{h}},\ laneMask,\ width));}
\DoxyCodeLine{00896\ \}}
\DoxyCodeLine{00897\ }
\DoxyCodeLine{00898\ \textcolor{preprocessor}{\#else\ }\textcolor{comment}{//\ HIP\ or\ CUDA\ SDK\ <\ 9.0}}
\DoxyCodeLine{00899\ }
\DoxyCodeLine{00900\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl(\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{int}\ srcLane,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
...
\DoxyCodeLine{00903\ \}}
\DoxyCodeLine{00904\ }
\DoxyCodeLine{00905\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_up(\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ delta,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
...
\DoxyCodeLine{00908\ \}}
\DoxyCodeLine{00909\ }
\DoxyCodeLine{00910\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_down(\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ delta,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
...
\DoxyCodeLine{00913\ \}}
\DoxyCodeLine{00914\ }
\DoxyCodeLine{00915\ \_\_device\_\_\ EIGEN\_STRONG\_INLINE\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_shfl\_xor(\doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ var,\ \textcolor{keywordtype}{int}\ laneMask,\ \textcolor{keywordtype}{int}\ width=warpSize)\ \{}
...
\DoxyCodeLine{00926\ EIGEN\_STRONG\_INLINE\ \_\_device\_\_\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}\ \_\_ldg(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1half}{Eigen::half}}*\ ptr)\ \{}
...
\DoxyCodeLine{00934\ \textcolor{keyword}{struct\ }hash<Eigen::half>\ \{}
\DoxyCodeLine{00935\ \ \ EIGEN\_DEVICE\_FUNC\ EIGEN\_STRONG\_INLINE\ std::size\_t\ operator()(\textcolor{keyword}{const}\ Eigen::half\&\ a)\textcolor{keyword}{\ const\ }\{}
