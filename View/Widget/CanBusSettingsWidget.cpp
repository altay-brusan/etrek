...
#include "ui_CanBusSettingsWidget.h"

CanBusSettingsWidget::CanBusSettingsWidget(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::CanBusSettingsWidget)
{
    ui->setupUi(this);
    ...
    ui->interfaceNameComboBox->setStyleSheet(comboCss);
    ui->baudRateComboBox->setStyleSheet(comboCss);
    ui->protocolTypeComboBox->setStyleSheet(comboCss);
    ui->listenOnlyModeCheckBox->setStyleSheet(checkCss);
	ui->terminatorResistorCheckBox->setStyleSheet(checkCss);


}

CanBusSettingsWidget::~CanBusSettingsWidget()
{
    delete ui;
}
