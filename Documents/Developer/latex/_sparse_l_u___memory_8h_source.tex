...
\hypertarget{_sparse_l_u___memory_8h_source}{}\label{_sparse_l_u___memory_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_Memory.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_Memory.h}}
...
\DoxyCodeLine{00039\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ LUnumTempV(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ m,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ w,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ t,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ b)}
\DoxyCodeLine{00040\ \{}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ LUTempSpace(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&m,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ w)}
\DoxyCodeLine{00046\ \{}
\DoxyCodeLine{00047\ \ \ \textcolor{keywordflow}{return}\ (2*w\ +\ 4\ +\ LUNoMarker)\ *\ m\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}})\ +\ (w\ +\ 1)\ *\ m\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{class_eigen_1_1_product}{Scalar}});}
\DoxyCodeLine{00048\ \}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ }
...
\DoxyCodeLine{00072\ \ \ \ \ new\_len\ =\ (std::max)(length+1,\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}(alpha\ *\ length));}
\DoxyCodeLine{00073\ \ \ }
...
\DoxyCodeLine{00105\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ tries\ =\ 0;\ \textcolor{comment}{//\ Number\ of\ attempts}}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \textcolor{keywordflow}{do}\ }
\DoxyCodeLine{00107\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ alpha\ =\ (alpha\ +\ 1)/2;}
\DoxyCodeLine{00109\ \ \ \ \ \ \ \ \ new\_len\ =\ (std::max)(length+1,\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}(alpha\ *\ length));}
...
\DoxyCodeLine{00151\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_ac018b8ed9664d4e19e34f1ff2d6c578a}{SparseLUImpl<Scalar,StorageIndex>::memInit}}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ annz,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lwork,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ fillratio,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ panel\_size,\ \ GlobalLU\_t\&\ glu)}
\DoxyCodeLine{00152\ \{}
\DoxyCodeLine{00153\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ num\_expansions\ =\ glu.num\_expansions;\ \textcolor{comment}{//No\ memory\ expansions\ so\ far}}
...
\DoxyCodeLine{00156\ \ \ glu.nzlmax\ =\ (std::max)(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}(4),\ fillratio)\ *\ (annz+1)\ /\ 4;\ \textcolor{comment}{//\ estimated\ \ nnz\ in\ L\ factor}}
\DoxyCodeLine{00157\ \ \ \textcolor{comment}{//\ Return\ the\ estimated\ size\ to\ the\ user\ if\ necessary}}
\DoxyCodeLine{00158\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ tempSpace;}
\DoxyCodeLine{00159\ \ \ tempSpace\ =\ (2*panel\_size\ +\ 4\ +\ LUNoMarker)\ *\ m\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}})\ +\ (panel\_size\ +\ 1)\ *\ m\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}});}
\DoxyCodeLine{00160\ \ \ \textcolor{keywordflow}{if}\ (lwork\ ==\ emptyIdxLU)\ }
\DoxyCodeLine{00161\ \ \ \{}
\DoxyCodeLine{00162\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ estimated\_size;}
\DoxyCodeLine{00163\ \ \ \ \ estimated\_size\ =\ (5\ *\ n\ +\ 5)\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}})\ \ +\ tempSpace}
\DoxyCodeLine{00164\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ +\ (glu.nzlmax\ +\ glu.nzumax)\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}})\ +\ (glu.nzlumax+glu.nzumax)\ *\ \ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}})\ +\ n;\ }
...
\DoxyCodeLine{00179\ \ \ \{}
\DoxyCodeLine{00180\ \ \ \ \ \textcolor{keywordflow}{if}(\ \ \ \ \ (\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<ScalarVector>}}(glu.lusup,\ glu.nzlumax,\ 0,\ 0,\ num\_expansions)<0)}
\DoxyCodeLine{00181\ \ \ \ \ \ \ \ \ ||\ \ (\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<ScalarVector>}}(glu.ucol,\ \ glu.nzumax,\ \ 0,\ 0,\ num\_expansions)<0)}
\DoxyCodeLine{00182\ \ \ \ \ \ \ \ \ ||\ \ (\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<IndexVector>}}\ (glu.lsub,\ \ glu.nzlmax,\ \ 0,\ 0,\ num\_expansions)<0)}
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ ||\ \ (\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<IndexVector>}}\ (glu.usub,\ \ glu.nzumax,\ \ 0,\ 1,\ num\_expansions)<0)\ )}
\DoxyCodeLine{00184\ \ \ \ \ \{}
...
\DoxyCodeLine{00209\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_a2a6465f1173fd8b74b2e5b8ceec53343}{SparseLUImpl<Scalar,StorageIndex>::memXpand}}(VectorType\&\ vec,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ maxlen,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nbElts,\ MemType\ memtype,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ num\_expansions)}
\DoxyCodeLine{00210\ \{}
\DoxyCodeLine{00211\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ failed\_size;\ }
\DoxyCodeLine{00212\ \ \ \textcolor{keywordflow}{if}\ (memtype\ ==\ USUB)}
\DoxyCodeLine{00213\ \ \ \ \ \ failed\_size\ =\ this-\/>\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<VectorType>}}(vec,\ maxlen,\ nbElts,\ 1,\ num\_expansions);}
\DoxyCodeLine{00214\ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00215\ \ \ \ \ failed\_size\ =\ this-\/>\doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_acc7811f7de19ffb804cb4b1fd5288f3e}{expand<VectorType>}}(vec,\ maxlen,\ nbElts,\ 0,\ num\_expansions);}
\DoxyCodeLine{00216\ }
