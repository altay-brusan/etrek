...
namespace Etrek::Core::Repository {
    ...
    public:
         ...
         */
        explicit AuthenticationRepository(std::shared_ptr<DatabaseConnectionSetting> connectionSetting, TranslationProvider* translator);
         ...
         */
        Result<QVector<Entity::User>> getAllInactiveUsers() const;
         ...
         */
        Result<User> createUser(Entity::User& user);
         ...
         */
        Result<User> updateUser(Entity::User& user);
         ...
         */
        Result<User> deleteUser(Entity::User& user);
         ...
         */
        Result<int> createRole(const QString& roleName);
         ...
         */
        Result<QString> assignRoleToUser(int userId, int roleId);
         ...
         * @return Result containing a success message, or an error message.
         */
        Result<QString> removeRoleFromUser(int userId, int roleId);
         ...
         */
        Result<bool> checkUserHasRole(int userId, const QString& roleName);
    ...
    private:
         ...
         */
        Result<QVector<Entity::Role>> getUserRoles(int userId, QSqlDatabase& db) const;
