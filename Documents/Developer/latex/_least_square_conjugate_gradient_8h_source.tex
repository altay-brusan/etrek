...
\hypertarget{_least_square_conjugate_gradient_8h_source}{}\label{_least_square_conjugate_gradient_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/IterativeLinearSolvers/LeastSquareConjugateGradient.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/IterativeLinearSolvers/LeastSquareConjugateGradient.h}}
...
\DoxyCodeLine{00028\ \textcolor{keywordtype}{void}\ least\_square\_conjugate\_gradient(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{MatrixType}}\&\ mat,\ \textcolor{keyword}{const}\ Rhs\&\ rhs,\ Dest\&\ x,}
...
\DoxyCodeLine{00040\ \ \ }
\DoxyCodeLine{00041\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ mat.rows(),\ n\ =\ mat.cols();}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00072\ }
\DoxyCodeLine{00073\ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}\ alpha\ =\ absNew\ /\ tmp.squaredNorm();\ \ \ \ \ \ \textcolor{comment}{//\ the\ amount\ we\ travel\ on\ dir}}
...
\DoxyCodeLine{00097\ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ \_Preconditioner\ =\ \doxymbox{\hyperlink{class_eigen_1_1_least_square_diagonal_preconditioner}{LeastSquareDiagonalPreconditioner<typename\ \_MatrixType::Scalar>}}\ >}
\DoxyCodeLine{00098\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient}{LeastSquaresConjugateGradient}};}
\DoxyCodeLine{00099\ }
...
\DoxyCodeLine{00103\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{traits}}<\doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient}{LeastSquaresConjugateGradient}}<\_MatrixType,\_Preconditioner>\ >}
\DoxyCodeLine{00104\ \{}
...
\DoxyCodeLine{00149\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient_ace69f423fcc1f8960d0e2de0667447c9}{LeastSquaresConjugateGradient}}\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{class_eigen_1_1_iterative_solver_base_a0922f2be45082690d7734aa6732fc493}{IterativeSolverBase}}<LeastSquaresConjugateGradient<\_MatrixType,\_Preconditioner>\ >}
\DoxyCodeLine{00150\ \{}
\DoxyCodeLine{00151\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_iterative_solver_base_a0922f2be45082690d7734aa6732fc493}{IterativeSolverBase<LeastSquaresConjugateGradient>}}\ Base;}
...
\DoxyCodeLine{00164\ }
\DoxyCodeLine{00166\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient_ace69f423fcc1f8960d0e2de0667447c9}{LeastSquaresConjugateGradient}}()\ :\ Base()\ \{\}}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ MatrixDerived>}
\DoxyCodeLine{00179\ \ \ \textcolor{keyword}{explicit}\ \doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient_a91c4f2edc20f93cee9b721165937fb99}{LeastSquaresConjugateGradient}}(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1_eigen_base}{EigenBase<MatrixDerived>}}\&\ A)\ :\ Base(A.derived())\ \{\}}
\DoxyCodeLine{00180\ }
\DoxyCodeLine{00181\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_least_squares_conjugate_gradient}{\string~LeastSquaresConjugateGradient}}()\ \{\}}
\DoxyCodeLine{00182\ }
...
\DoxyCodeLine{00187\ \ \ \ \ m\_iterations\ =\ \doxymbox{\hyperlink{class_eigen_1_1_iterative_solver_base_a168a74c8dceb6233b220031fdd756ba0}{Base::maxIterations}}();}
...
\DoxyCodeLine{00191\ \ \ \ \ m\_info\ =\ m\_error\ <=\ Base::m\_tolerance\ ?\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ :\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}};}
\DoxyCodeLine{00192\ \ \ \}}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \};}
\DoxyCodeLine{00195\ }
