...
\hypertarget{_general_matrix_vector_8h_source}{}\label{_general_matrix_vector_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/products/GeneralMatrixVector.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/products/GeneralMatrixVector.h}}
...
\DoxyCodeLine{00024\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1gemv__packet__cond}{gemv\_packet\_cond}}\ \{\ \textcolor{keyword}{typedef}\ T3\ type;\ \};}
\DoxyCodeLine{00025\ }
...
\DoxyCodeLine{00027\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1gemv__packet__cond}{gemv\_packet\_cond}}<GEMVPacketFull,\ T1,\ T2,\ T3>\ \{\ \textcolor{keyword}{typedef}\ T1\ type;\ \};}
\DoxyCodeLine{00028\ }
...
\DoxyCodeLine{00030\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1gemv__packet__cond}{gemv\_packet\_cond}}<GEMVPacketHalf,\ T1,\ T2,\ T3>\ \{\ \textcolor{keyword}{typedef}\ T2\ type;\ \};}
\DoxyCodeLine{00031\ }
...
\DoxyCodeLine{00033\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits}}}
\DoxyCodeLine{00034\ \{}
\DoxyCodeLine{00035\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_scalar_binary_op_traits}{ScalarBinaryOpTraits<LhsScalar,\ RhsScalar>::ReturnType}}\ ResScalar;}
\DoxyCodeLine{00036\ }
...
\DoxyCodeLine{00079\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1general__matrix__vector__product}{general\_matrix\_vector\_product}}<\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}},LhsScalar,LhsMapper,\doxymbox{\hyperlink{group__enums_ggaacded1a18ae58b0f554751f6cdf9eb13a0103672ae41005ab03b4176c765afd62}{ColMajor}},ConjugateLhs,RhsScalar,RhsMapper,ConjugateRhs,Version>}
\DoxyCodeLine{00080\ \{}
\DoxyCodeLine{00081\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar>}}\ Traits;}
\DoxyCodeLine{00082\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar,GEMVPacketHalf>}}\ HalfTraits;}
\DoxyCodeLine{00083\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar,GEMVPacketQuarter>}}\ QuarterTraits;}
\DoxyCodeLine{00084\ }
\DoxyCodeLine{00085\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_scalar_binary_op_traits}{ScalarBinaryOpTraits<LhsScalar,\ RhsScalar>::ReturnType}}\ ResScalar;}
\DoxyCodeLine{00086\ }
...
\DoxyCodeLine{00100\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols,}
\DoxyCodeLine{00101\ \ \ \textcolor{keyword}{const}\ LhsMapper\&\ lhs,}
\DoxyCodeLine{00102\ \ \ \textcolor{keyword}{const}\ RhsMapper\&\ rhs,}
\DoxyCodeLine{00103\ \ \ \ \ \ \ \ \ ResScalar*\ res,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ resIncr,}
...
\DoxyCodeLine{00108\ EIGEN\_DEVICE\_FUNC\ EIGEN\_DONT\_INLINE\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1general__matrix__vector__product}{general\_matrix\_vector\_product<Index,LhsScalar,LhsMapper,ColMajor,ConjugateLhs,RhsScalar,RhsMapper,ConjugateRhs,Version>::run}}(}
\DoxyCodeLine{00109\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols,}
\DoxyCodeLine{00110\ \ \ \textcolor{keyword}{const}\ LhsMapper\&\ alhs,}
\DoxyCodeLine{00111\ \ \ \textcolor{keyword}{const}\ RhsMapper\&\ rhs,}
\DoxyCodeLine{00112\ \ \ \ \ \ \ \ \ ResScalar*\ res,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ resIncr,}
...
\DoxyCodeLine{00121\ }
\DoxyCodeLine{00122\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsScalar,RhsScalar,ConjugateLhs,ConjugateRhs>}}\ cj;}
\DoxyCodeLine{00123\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacket,RhsPacket,ConjugateLhs,ConjugateRhs>}}\ pcj;}
\DoxyCodeLine{00124\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacketHalf,RhsPacketHalf,ConjugateLhs,ConjugateRhs>}}\ pcj\_half;}
\DoxyCodeLine{00125\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacketQuarter,RhsPacketQuarter,ConjugateLhs,ConjugateRhs>}}\ pcj\_quarter;}
\DoxyCodeLine{00126\ }
\DoxyCodeLine{00127\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lhsStride\ =\ lhs.stride();}
\DoxyCodeLine{00128\ \ \ \textcolor{comment}{//\ TODO:\ for\ padded\ aligned\ inputs,\ we\ could\ enable\ aligned\ reads}}
\DoxyCodeLine{00129\ \ \ \textcolor{keyword}{enum}\ \{\ LhsAlignment\ =\ \doxymbox{\hyperlink{group__enums_gga45fe06e29902b7a2773de05ba27b47a1a4e19dd09d5ff42295ba1d72d12a46686}{Unaligned}},}
...
\DoxyCodeLine{00136\ \ \ \};}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00138\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n8\ =\ rows-\/8*ResPacketSize+1;}
\DoxyCodeLine{00139\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n4\ =\ rows-\/4*ResPacketSize+1;}
\DoxyCodeLine{00140\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n3\ =\ rows-\/3*ResPacketSize+1;}
\DoxyCodeLine{00141\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n2\ =\ rows-\/2*ResPacketSize+1;}
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n1\ =\ rows-\/1*ResPacketSize+1;}
\DoxyCodeLine{00143\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\_half\ =\ rows-\/1*ResPacketSizeHalf+1;}
\DoxyCodeLine{00144\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\_quarter\ =\ rows-\/1*ResPacketSizeQuarter+1;}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00146\ \ \ \textcolor{comment}{//\ TODO:\ improve\ the\ following\ heuristic:}}
\DoxyCodeLine{00147\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ block\_cols\ =\ cols<128\ ?\ cols\ :\ (lhsStride*\textcolor{keyword}{sizeof}(LhsScalar)<32000?16:4);}
...
\DoxyCodeLine{00151\ }
\DoxyCodeLine{00152\ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j2=0;\ j2<cols;\ j2+=block\_cols)}
\DoxyCodeLine{00153\ \ \ \{}
\DoxyCodeLine{00154\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jend\ =\ numext::mini(j2+block\_cols,cols);}
\DoxyCodeLine{00155\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=0;}
...
\DoxyCodeLine{00166\ }
\DoxyCodeLine{00167\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00168\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00196\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00215\ }
\DoxyCodeLine{00216\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00217\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00233\ }
\DoxyCodeLine{00234\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00235\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00247\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00248\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00258\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00259\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00269\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
\DoxyCodeLine{00270\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00280\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=j2;\ j<jend;\ j+=1)}
...
\DoxyCodeLine{00298\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1general__matrix__vector__product}{general\_matrix\_vector\_product}}<\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}},LhsScalar,LhsMapper,\doxymbox{\hyperlink{group__enums_ggaacded1a18ae58b0f554751f6cdf9eb13a77c993a8d9f6efe5c1159fb2ab07dd4f}{RowMajor}},ConjugateLhs,RhsScalar,RhsMapper,ConjugateRhs,Version>}
\DoxyCodeLine{00299\ \{}
\DoxyCodeLine{00300\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar>}}\ Traits;}
\DoxyCodeLine{00301\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar,GEMVPacketHalf>}}\ HalfTraits;}
\DoxyCodeLine{00302\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gemv__traits}{gemv\_traits<LhsScalar,RhsScalar,GEMVPacketQuarter>}}\ QuarterTraits;}
\DoxyCodeLine{00303\ }
\DoxyCodeLine{00304\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_scalar_binary_op_traits}{ScalarBinaryOpTraits<LhsScalar,\ RhsScalar>::ReturnType}}\ ResScalar;}
\DoxyCodeLine{00305\ }
...
\DoxyCodeLine{00319\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols,}
\DoxyCodeLine{00320\ \ \ \textcolor{keyword}{const}\ LhsMapper\&\ lhs,}
\DoxyCodeLine{00321\ \ \ \textcolor{keyword}{const}\ RhsMapper\&\ rhs,}
\DoxyCodeLine{00322\ \ \ \ \ \ \ \ \ ResScalar*\ res,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ resIncr,}
...
\DoxyCodeLine{00327\ EIGEN\_DEVICE\_FUNC\ EIGEN\_DONT\_INLINE\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1general__matrix__vector__product}{general\_matrix\_vector\_product<Index,LhsScalar,LhsMapper,RowMajor,ConjugateLhs,RhsScalar,RhsMapper,ConjugateRhs,Version>::run}}(}
\DoxyCodeLine{00328\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols,}
\DoxyCodeLine{00329\ \ \ \textcolor{keyword}{const}\ LhsMapper\&\ alhs,}
\DoxyCodeLine{00330\ \ \ \textcolor{keyword}{const}\ RhsMapper\&\ rhs,}
\DoxyCodeLine{00331\ \ \ ResScalar*\ res,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ resIncr,}
...
\DoxyCodeLine{00339\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsScalar,RhsScalar,ConjugateLhs,ConjugateRhs>}}\ cj;}
\DoxyCodeLine{00340\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacket,RhsPacket,ConjugateLhs,ConjugateRhs>}}\ pcj;}
\DoxyCodeLine{00341\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacketHalf,RhsPacketHalf,ConjugateLhs,ConjugateRhs>}}\ pcj\_half;}
\DoxyCodeLine{00342\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper<LhsPacketQuarter,RhsPacketQuarter,ConjugateLhs,ConjugateRhs>}}\ pcj\_quarter;}
\DoxyCodeLine{00343\ }
...
\DoxyCodeLine{00346\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n8\ =\ lhs.stride()*\textcolor{keyword}{sizeof}(LhsScalar)>32000\ ?\ 0\ :\ rows-\/7;}
\DoxyCodeLine{00347\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n4\ =\ rows-\/3;}
\DoxyCodeLine{00348\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n2\ =\ rows-\/1;}
\DoxyCodeLine{00349\ }
\DoxyCodeLine{00350\ \ \ \textcolor{comment}{//\ TODO:\ for\ padded\ aligned\ inputs,\ we\ could\ enable\ aligned\ reads}}
\DoxyCodeLine{00351\ \ \ \textcolor{keyword}{enum}\ \{\ LhsAlignment\ =\ \doxymbox{\hyperlink{group__enums_gga45fe06e29902b7a2773de05ba27b47a1a4e19dd09d5ff42295ba1d72d12a46686}{Unaligned}},}
...
\DoxyCodeLine{00360\ \ \ \};}
\DoxyCodeLine{00361\ }
\DoxyCodeLine{00362\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=0;}
\DoxyCodeLine{00363\ \ \ \textcolor{keywordflow}{for}(;\ i<n8;\ i+=8)}
\DoxyCodeLine{00364\ \ \ \{}
\DoxyCodeLine{00365\ \ \ \ \ ResPacket\ c0\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00366\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c1\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00367\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c2\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00368\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c3\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00369\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c4\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00370\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c5\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00371\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c6\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00372\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c7\ =\ pset1<ResPacket>(ResScalar(0));}
\DoxyCodeLine{00373\ }
\DoxyCodeLine{00374\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;}
...
\DoxyCodeLine{00378\ }
\DoxyCodeLine{00379\ \ \ \ \ \ \ c0\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+0,j),b0,c0);}
\DoxyCodeLine{00380\ \ \ \ \ \ \ c1\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+1,j),b0,c1);}
\DoxyCodeLine{00381\ \ \ \ \ \ \ c2\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+2,j),b0,c2);}
\DoxyCodeLine{00382\ \ \ \ \ \ \ c3\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+3,j),b0,c3);}
\DoxyCodeLine{00383\ \ \ \ \ \ \ c4\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+4,j),b0,c4);}
\DoxyCodeLine{00384\ \ \ \ \ \ \ c5\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+5,j),b0,c5);}
\DoxyCodeLine{00385\ \ \ \ \ \ \ c6\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+6,j),b0,c6);}
\DoxyCodeLine{00386\ \ \ \ \ \ \ c7\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+7,j),b0,c7);}
\DoxyCodeLine{00387\ \ \ \ \ \}}
\DoxyCodeLine{00388\ \ \ \ \ ResScalar\ cc0\ =\ predux(c0);}
\DoxyCodeLine{00389\ \ \ \ \ ResScalar\ cc1\ =\ predux(c1);}
\DoxyCodeLine{00390\ \ \ \ \ ResScalar\ cc2\ =\ predux(c2);}
\DoxyCodeLine{00391\ \ \ \ \ ResScalar\ cc3\ =\ predux(c3);}
\DoxyCodeLine{00392\ \ \ \ \ ResScalar\ cc4\ =\ predux(c4);}
\DoxyCodeLine{00393\ \ \ \ \ ResScalar\ cc5\ =\ predux(c5);}
\DoxyCodeLine{00394\ \ \ \ \ ResScalar\ cc6\ =\ predux(c6);}
\DoxyCodeLine{00395\ \ \ \ \ ResScalar\ cc7\ =\ predux(c7);}
\DoxyCodeLine{00396\ \ \ \ \ \textcolor{keywordflow}{for}(;\ j<cols;\ ++j)}
\DoxyCodeLine{00397\ \ \ \ \ \{}
\DoxyCodeLine{00398\ \ \ \ \ \ \ RhsScalar\ b0\ =\ rhs(j,0);}
\DoxyCodeLine{00399\ }
\DoxyCodeLine{00400\ \ \ \ \ \ \ cc0\ +=\ cj.pmul(lhs(i+0,j),\ b0);}
\DoxyCodeLine{00401\ \ \ \ \ \ \ cc1\ +=\ cj.pmul(lhs(i+1,j),\ b0);}
\DoxyCodeLine{00402\ \ \ \ \ \ \ cc2\ +=\ cj.pmul(lhs(i+2,j),\ b0);}
\DoxyCodeLine{00403\ \ \ \ \ \ \ cc3\ +=\ cj.pmul(lhs(i+3,j),\ b0);}
\DoxyCodeLine{00404\ \ \ \ \ \ \ cc4\ +=\ cj.pmul(lhs(i+4,j),\ b0);}
\DoxyCodeLine{00405\ \ \ \ \ \ \ cc5\ +=\ cj.pmul(lhs(i+5,j),\ b0);}
\DoxyCodeLine{00406\ \ \ \ \ \ \ cc6\ +=\ cj.pmul(lhs(i+6,j),\ b0);}
\DoxyCodeLine{00407\ \ \ \ \ \ \ cc7\ +=\ cj.pmul(lhs(i+7,j),\ b0);}
\DoxyCodeLine{00408\ \ \ \ \ \}}
\DoxyCodeLine{00409\ \ \ \ \ res[(i+0)*resIncr]\ +=\ alpha*cc0;}
\DoxyCodeLine{00410\ \ \ \ \ res[(i+1)*resIncr]\ +=\ alpha*cc1;}
\DoxyCodeLine{00411\ \ \ \ \ res[(i+2)*resIncr]\ +=\ alpha*cc2;}
\DoxyCodeLine{00412\ \ \ \ \ res[(i+3)*resIncr]\ +=\ alpha*cc3;}
\DoxyCodeLine{00413\ \ \ \ \ res[(i+4)*resIncr]\ +=\ alpha*cc4;}
\DoxyCodeLine{00414\ \ \ \ \ res[(i+5)*resIncr]\ +=\ alpha*cc5;}
\DoxyCodeLine{00415\ \ \ \ \ res[(i+6)*resIncr]\ +=\ alpha*cc6;}
\DoxyCodeLine{00416\ \ \ \ \ res[(i+7)*resIncr]\ +=\ alpha*cc7;}
\DoxyCodeLine{00417\ \ \ \}}
\DoxyCodeLine{00418\ \ \ \textcolor{keywordflow}{for}(;\ i<n4;\ i+=4)}
\DoxyCodeLine{00419\ \ \ \{}
\DoxyCodeLine{00420\ \ \ \ \ ResPacket\ c0\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00421\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c1\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00422\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c2\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00423\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c3\ =\ pset1<ResPacket>(ResScalar(0));}
\DoxyCodeLine{00424\ }
\DoxyCodeLine{00425\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;}
...
\DoxyCodeLine{00429\ }
\DoxyCodeLine{00430\ \ \ \ \ \ \ c0\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+0,j),b0,c0);}
\DoxyCodeLine{00431\ \ \ \ \ \ \ c1\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+1,j),b0,c1);}
\DoxyCodeLine{00432\ \ \ \ \ \ \ c2\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+2,j),b0,c2);}
\DoxyCodeLine{00433\ \ \ \ \ \ \ c3\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+3,j),b0,c3);}
\DoxyCodeLine{00434\ \ \ \ \ \}}
\DoxyCodeLine{00435\ \ \ \ \ ResScalar\ cc0\ =\ predux(c0);}
\DoxyCodeLine{00436\ \ \ \ \ ResScalar\ cc1\ =\ predux(c1);}
\DoxyCodeLine{00437\ \ \ \ \ ResScalar\ cc2\ =\ predux(c2);}
\DoxyCodeLine{00438\ \ \ \ \ ResScalar\ cc3\ =\ predux(c3);}
\DoxyCodeLine{00439\ \ \ \ \ \textcolor{keywordflow}{for}(;\ j<cols;\ ++j)}
\DoxyCodeLine{00440\ \ \ \ \ \{}
\DoxyCodeLine{00441\ \ \ \ \ \ \ RhsScalar\ b0\ =\ rhs(j,0);}
\DoxyCodeLine{00442\ }
\DoxyCodeLine{00443\ \ \ \ \ \ \ cc0\ +=\ cj.pmul(lhs(i+0,j),\ b0);}
\DoxyCodeLine{00444\ \ \ \ \ \ \ cc1\ +=\ cj.pmul(lhs(i+1,j),\ b0);}
\DoxyCodeLine{00445\ \ \ \ \ \ \ cc2\ +=\ cj.pmul(lhs(i+2,j),\ b0);}
\DoxyCodeLine{00446\ \ \ \ \ \ \ cc3\ +=\ cj.pmul(lhs(i+3,j),\ b0);}
\DoxyCodeLine{00447\ \ \ \ \ \}}
\DoxyCodeLine{00448\ \ \ \ \ res[(i+0)*resIncr]\ +=\ alpha*cc0;}
\DoxyCodeLine{00449\ \ \ \ \ res[(i+1)*resIncr]\ +=\ alpha*cc1;}
\DoxyCodeLine{00450\ \ \ \ \ res[(i+2)*resIncr]\ +=\ alpha*cc2;}
\DoxyCodeLine{00451\ \ \ \ \ res[(i+3)*resIncr]\ +=\ alpha*cc3;}
\DoxyCodeLine{00452\ \ \ \}}
\DoxyCodeLine{00453\ \ \ \textcolor{keywordflow}{for}(;\ i<n2;\ i+=2)}
\DoxyCodeLine{00454\ \ \ \{}
\DoxyCodeLine{00455\ \ \ \ \ ResPacket\ c0\ =\ pset1<ResPacket>(ResScalar(0)),}
\DoxyCodeLine{00456\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ c1\ =\ pset1<ResPacket>(ResScalar(0));}
\DoxyCodeLine{00457\ }
\DoxyCodeLine{00458\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;}
...
\DoxyCodeLine{00462\ }
\DoxyCodeLine{00463\ \ \ \ \ \ \ c0\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+0,j),b0,c0);}
\DoxyCodeLine{00464\ \ \ \ \ \ \ c1\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i+1,j),b0,c1);}
\DoxyCodeLine{00465\ \ \ \ \ \}}
\DoxyCodeLine{00466\ \ \ \ \ ResScalar\ cc0\ =\ predux(c0);}
\DoxyCodeLine{00467\ \ \ \ \ ResScalar\ cc1\ =\ predux(c1);}
\DoxyCodeLine{00468\ \ \ \ \ \textcolor{keywordflow}{for}(;\ j<cols;\ ++j)}
\DoxyCodeLine{00469\ \ \ \ \ \{}
\DoxyCodeLine{00470\ \ \ \ \ \ \ RhsScalar\ b0\ =\ rhs(j,0);}
\DoxyCodeLine{00471\ }
\DoxyCodeLine{00472\ \ \ \ \ \ \ cc0\ +=\ cj.pmul(lhs(i+0,j),\ b0);}
\DoxyCodeLine{00473\ \ \ \ \ \ \ cc1\ +=\ cj.pmul(lhs(i+1,j),\ b0);}
\DoxyCodeLine{00474\ \ \ \ \ \}}
\DoxyCodeLine{00475\ \ \ \ \ res[(i+0)*resIncr]\ +=\ alpha*cc0;}
\DoxyCodeLine{00476\ \ \ \ \ res[(i+1)*resIncr]\ +=\ alpha*cc1;}
\DoxyCodeLine{00477\ \ \ \}}
\DoxyCodeLine{00478\ \ \ \textcolor{keywordflow}{for}(;\ i<rows;\ ++i)}
\DoxyCodeLine{00479\ \ \ \{}
\DoxyCodeLine{00480\ \ \ \ \ ResPacket\ c0\ =\ pset1<ResPacket>(ResScalar(0));}
\DoxyCodeLine{00481\ \ \ \ \ ResPacketHalf\ c0\_h\ =\ pset1<ResPacketHalf>(ResScalar(0));}
\DoxyCodeLine{00482\ \ \ \ \ ResPacketQuarter\ c0\_q\ =\ pset1<ResPacketQuarter>(ResScalar(0));}
\DoxyCodeLine{00483\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;}
...
\DoxyCodeLine{00487\ \ \ \ \ \ \ c0\ =\ pcj.pmadd(lhs.template\ load<LhsPacket,LhsAlignment>(i,j),b0,c0);}
\DoxyCodeLine{00488\ \ \ \ \ \}}
\DoxyCodeLine{00489\ \ \ \ \ ResScalar\ cc0\ =\ predux(c0);}
...
\DoxyCodeLine{00494\ \ \ \ \ \ \ \ \ \ \ c0\_h\ =\ pcj\_half.pmadd(lhs.template\ load<LhsPacketHalf,LhsAlignment>(i,j),b0,c0\_h);}
\DoxyCodeLine{00495\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00496\ \ \ \ \ \ \ cc0\ +=\ predux(c0\_h);}
\DoxyCodeLine{00497\ \ \ \ \ \}}
...
\DoxyCodeLine{00502\ \ \ \ \ \ \ \ \ \ \ c0\_q\ =\ pcj\_quarter.pmadd(lhs.template\ load<LhsPacketQuarter,LhsAlignment>(i,j),b0,c0\_q);}
\DoxyCodeLine{00503\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00504\ \ \ \ \ \ \ cc0\ +=\ predux(c0\_q);}
\DoxyCodeLine{00505\ \ \ \ \ \}}
\DoxyCodeLine{00506\ \ \ \ \ \textcolor{keywordflow}{for}(;\ j<cols;\ ++j)}
\DoxyCodeLine{00507\ \ \ \ \ \{}
\DoxyCodeLine{00508\ \ \ \ \ \ \ cc0\ +=\ cj.pmul(lhs(i,j),\ rhs(j,0));}
\DoxyCodeLine{00509\ \ \ \ \ \}}
\DoxyCodeLine{00510\ \ \ \ \ res[i*resIncr]\ +=\ alpha*cc0;}
\DoxyCodeLine{00511\ \ \ \}}
\DoxyCodeLine{00512\ \}}
\DoxyCodeLine{00513\ }
