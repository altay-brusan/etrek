...
#include "ui_RS232SettingsWidget.h"

RS232SettingsWidget::RS232SettingsWidget(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::RS232SettingsWidget)
{
    ui->setupUi(this);
...
RS232SettingsWidget::~RS232SettingsWidget()
{
    delete ui;
}
