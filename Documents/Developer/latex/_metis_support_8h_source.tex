...
\hypertarget{_metis_support_8h_source}{}\label{_metis_support_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/MetisSupport/MetisSupport.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/MetisSupport/MetisSupport.h}}
...
\DoxyCodeLine{00022\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1_metis_ordering}{MetisOrdering}}}
\DoxyCodeLine{00023\ \{}
\DoxyCodeLine{00024\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00025\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_permutation_matrix}{PermutationMatrix<Dynamic,Dynamic,StorageIndex>}}\ PermutationType;}
\DoxyCodeLine{00026\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_matrix}{Matrix<StorageIndex,Dynamic,1>}}\ IndexVector;\ }
\DoxyCodeLine{00027\ \ \ }
\DoxyCodeLine{00028\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ MatrixType>}
\DoxyCodeLine{00029\ \ \ \textcolor{keywordtype}{void}\ get\_symmetrized\_graph(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_transform}{MatrixType}}\&\ A)}
\DoxyCodeLine{00030\ \ \ \{}
\DoxyCodeLine{00031\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ A.cols();\ }
...
\DoxyCodeLine{00034\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_transform}{MatrixType}}\ At\ =\ A.transpose();\ }
\DoxyCodeLine{00035\ \ \ \ \ \textcolor{comment}{//\ Get\ the\ number\ of\ nonzeros\ elements\ in\ each\ row/col\ of\ At+A}}
\DoxyCodeLine{00036\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ TotNz\ =\ 0;\ }
\DoxyCodeLine{00037\ \ \ \ \ IndexVector\ visited(m);\ }
\DoxyCodeLine{00038\ \ \ \ \ visited.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(-\/1);\ }
...
\DoxyCodeLine{00045\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ idx\ =\ it.index();\ \textcolor{comment}{//\ Get\ the\ row\ index\ (for\ column\ major)\ or\ column\ index\ (for\ row\ major)}}
...
\DoxyCodeLine{00055\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ idx\ =\ it.index();\ }
...
\DoxyCodeLine{00069\ \ \ \ \ visited.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(-\/1);\ }
...
\DoxyCodeLine{00103\ \ \ \textcolor{keywordtype}{void}\ operator()\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_transform}{MatrixType}}\&\ A,\ PermutationType\&\ matperm)}
\DoxyCodeLine{00104\ \ \ \{}
...
\DoxyCodeLine{00112\ \ \ \ \ \ output\_error\ =\ METIS\_NodeND(\&m,\ m\_indexPtr.data(),\ m\_innerIndices.data(),\ NULL,\ NULL,\ perm.data(),\ iperm.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_a322d4d48cc285b60e0dff100db522342}{data}}());}
\DoxyCodeLine{00113\ \ \ \ \ \ }
...
\DoxyCodeLine{00124\ \ \ \ \ }
\DoxyCodeLine{00125\ \ \ \ \ \ matperm.\doxymbox{\hyperlink{class_eigen_1_1_permutation_base_a0e0fda6e84d69e02432e4770359bb532}{resize}}(m);}
\DoxyCodeLine{00126\ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ j\ =\ 0;\ j\ <\ m;\ j++)}
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ matperm.\doxymbox{\hyperlink{class_eigen_1_1_permutation_matrix_a9a2ae1608cc19e77e77863fce02f9066}{indices}}()(iperm(j))\ =\ j;}
\DoxyCodeLine{00128\ \ \ \ }
\DoxyCodeLine{00129\ \ \ \}}
\DoxyCodeLine{00130\ \ \ }
