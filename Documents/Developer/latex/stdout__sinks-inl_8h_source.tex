...
\hypertarget{stdout__sinks-inl_8h_source}{}\label{stdout__sinks-inl_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/spdlog/include/spdlog/sinks/stdout\_sinks-\/inl.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/spdlog/include/spdlog/sinks/stdout\_sinks-\/inl.h}}
...
\DoxyCodeLine{00036\ \ \ \ \ \ \ formatter\_(details::make\_unique<spdlog::pattern\_formatter>())\ \{}
...
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ throw\_spdlog\_ex(\textcolor{stringliteral}{"{}spdlog::stdout\_sink\_base:\ \_get\_osfhandle()\ failed"{}},\ errno);}
\DoxyCodeLine{00047\ \ \ \ \ \}}
...
\DoxyCodeLine{00052\ SPDLOG\_INLINE\ \textcolor{keywordtype}{void}\ stdout\_sink\_base<ConsoleMutex>::log(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\ \{}
...
\DoxyCodeLine{00085\ \ \ \ \ formatter\_\ =\ std::unique\_ptr<spdlog::formatter>(\textcolor{keyword}{new}\ pattern\_formatter(pattern));}
\DoxyCodeLine{00086\ \}}
\DoxyCodeLine{00087\ }
