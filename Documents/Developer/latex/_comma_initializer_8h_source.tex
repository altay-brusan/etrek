...
\hypertarget{_comma_initializer_8h_source}{}\label{_comma_initializer_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/CommaInitializer.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/CommaInitializer.h}}
...
\DoxyCodeLine{00043\ \ \ \textcolor{keyword}{inline}\ CommaInitializer(XprType\&\ xpr,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base}{DenseBase<OtherDerived>}}\&\ other)}
...
\DoxyCodeLine{00085\ \ \ CommaInitializer\&\ operator,(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base}{DenseBase<OtherDerived>}}\&\ other)}
\DoxyCodeLine{00086\ \ \ \{}
...
\DoxyCodeLine{00109\ \ \ \{}
\DoxyCodeLine{00110\ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer_a87dd22a8aa63222a264d263a254255b1}{finished}}();}
\DoxyCodeLine{00111\ \ \ \}}
\DoxyCodeLine{00112\ }
\DoxyCodeLine{00120\ \ \ EIGEN\_DEVICE\_FUNC}
\DoxyCodeLine{00121\ \ \ \textcolor{keyword}{inline}\ XprType\&\ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer_a87dd22a8aa63222a264d263a254255b1}{finished}}()\ \{}
...
\DoxyCodeLine{00129\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\_row;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ current\ row\ id}}
\DoxyCodeLine{00130\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\_col;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ current\ col\ id}}
\DoxyCodeLine{00131\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\_currentBlockRows;\ \textcolor{comment}{//\ current\ block\ height}}
\DoxyCodeLine{00132\ \};}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00147\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Derived>}
\DoxyCodeLine{00148\ EIGEN\_DEVICE\_FUNC\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer}{CommaInitializer<Derived>}}\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base_ae55fbfa5630cabf2a9cba1248581bc66}{DenseBase<Derived>::operator<<\ }}(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base_a5feed465b3a8e60c47e73ecce83e39a2}{Scalar}}\&\ s)}
\DoxyCodeLine{00149\ \{}
\DoxyCodeLine{00150\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer}{CommaInitializer<Derived>}}(*\textcolor{keyword}{static\_cast<}Derived*\textcolor{keyword}{>}(\textcolor{keyword}{this}),\ s);}
\DoxyCodeLine{00151\ \}}
\DoxyCodeLine{00152\ }
...
\DoxyCodeLine{00156\ EIGEN\_DEVICE\_FUNC\ \textcolor{keyword}{inline}\ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer}{CommaInitializer<Derived>}}}
\DoxyCodeLine{00157\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base_ae55fbfa5630cabf2a9cba1248581bc66}{DenseBase<Derived>::operator<<}}(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_dense_base_ae966dfaa11cfd07e87da040b7a9d8216}{DenseBase<OtherDerived>}}\&\ other)}
\DoxyCodeLine{00158\ \{}
\DoxyCodeLine{00159\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{struct_eigen_1_1_comma_initializer}{CommaInitializer<Derived>}}(*\textcolor{keyword}{static\_cast<}Derived\ *\textcolor{keyword}{>}(\textcolor{keyword}{this}),\ other);}
\DoxyCodeLine{00160\ \}}
\DoxyCodeLine{00161\ }
