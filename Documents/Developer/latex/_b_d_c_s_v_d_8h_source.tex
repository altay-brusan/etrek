...
\hypertarget{_b_d_c_s_v_d_8h_source}{}\label{_b_d_c_s_v_d_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SVD/BDCSVD.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SVD/BDCSVD.h}}
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{00033\ \doxymbox{\hyperlink{struct_eigen_1_1_i_o_format}{IOFormat}}\ bdcsvdfmt(8,\ 0,\ \textcolor{stringliteral}{"{},\ "{}},\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}},\ \textcolor{stringliteral}{"{}\ \ ["{}},\ \textcolor{stringliteral}{"{}]"{}});}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00035\ \ \ }
\DoxyCodeLine{00036\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ \_MatrixType>\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d}{BDCSVD}};}
\DoxyCodeLine{00037\ }
...
\DoxyCodeLine{00041\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{traits}}<\doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d}{BDCSVD}}<\_MatrixType>\ >}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{traits}}<\_MatrixType>}
\DoxyCodeLine{00043\ \{}
\DoxyCodeLine{00044\ \ \ \textcolor{keyword}{typedef}\ \_MatrixType\ MatrixType;}
\DoxyCodeLine{00045\ \};\ \ }
\DoxyCodeLine{00046\ }
...
\DoxyCodeLine{00073\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a39514816d38f9c418cf3f3514b511c2c}{BDCSVD}}\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_abed06fc6f4b743e1f76a7b317539da87}{SVDBase}}<BDCSVD<\_MatrixType>\ >}
\DoxyCodeLine{00074\ \{}
\DoxyCodeLine{00075\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_abed06fc6f4b743e1f76a7b317539da87}{SVDBase<BDCSVD>}}\ Base;}
\DoxyCodeLine{00076\ \ \ \ \ }
...
\DoxyCodeLine{00080\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a705a7c2709e1624ccc19aa748a78d473}{Base::computeU}};}
\DoxyCodeLine{00081\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a5f12efcb791eb007d4a4890ac5255ac4}{Base::computeV}};}
\DoxyCodeLine{00082\ \ \ }
\DoxyCodeLine{00083\ \ \ \textcolor{keyword}{typedef}\ \_MatrixType\ MatrixType;}
\DoxyCodeLine{00084\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ MatrixType::Scalar\ Scalar;}
\DoxyCodeLine{00085\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ NumTraits<typename\ MatrixType::Scalar>::Real\ RealScalar;}
\DoxyCodeLine{00086\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ NumTraits<RealScalar>::Literal\ Literal;}
\DoxyCodeLine{00087\ \ \ \textcolor{keyword}{enum}\ \{}
\DoxyCodeLine{00088\ \ \ \ \ RowsAtCompileTime\ =\ MatrixType::RowsAtCompileTime,\ }
\DoxyCodeLine{00089\ \ \ \ \ ColsAtCompileTime\ =\ MatrixType::ColsAtCompileTime,\ }
\DoxyCodeLine{00090\ \ \ \ \ DiagSizeAtCompileTime\ =\ EIGEN\_SIZE\_MIN\_PREFER\_DYNAMIC(RowsAtCompileTime,\ ColsAtCompileTime),\ }
\DoxyCodeLine{00091\ \ \ \ \ MaxRowsAtCompileTime\ =\ MatrixType::MaxRowsAtCompileTime,\ }
\DoxyCodeLine{00092\ \ \ \ \ MaxColsAtCompileTime\ =\ MatrixType::MaxColsAtCompileTime,\ }
\DoxyCodeLine{00093\ \ \ \ \ MaxDiagSizeAtCompileTime\ =\ EIGEN\_SIZE\_MIN\_PREFER\_FIXED(MaxRowsAtCompileTime,\ MaxColsAtCompileTime),\ }
\DoxyCodeLine{00094\ \ \ \ \ MatrixOptions\ =\ MatrixType::Options}
\DoxyCodeLine{00095\ \ \ \};}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Base::MatrixUType\ MatrixUType;}
\DoxyCodeLine{00098\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Base::MatrixVType\ MatrixVType;}
\DoxyCodeLine{00099\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Base::SingularValuesType\ SingularValuesType;}
\DoxyCodeLine{00100\ \ \ }
\DoxyCodeLine{00101\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_matrix}{Matrix<Scalar,\ Dynamic,\ Dynamic,\ ColMajor>}}\ MatrixX;}
\DoxyCodeLine{00102\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_matrix}{Matrix<RealScalar,\ Dynamic,\ Dynamic,\ ColMajor>}}\ MatrixXr;}
\DoxyCodeLine{00103\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_matrix}{Matrix<RealScalar,\ Dynamic,\ 1>}}\ VectorType;}
\DoxyCodeLine{00104\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_array}{Array<RealScalar,\ Dynamic,\ 1>}}\ ArrayXr;}
\DoxyCodeLine{00105\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_array}{Array<Index,1,Dynamic>}}\ ArrayXi;}
\DoxyCodeLine{00106\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_ref}{Ref<ArrayXr>}}\ ArrayRef;}
\DoxyCodeLine{00107\ \ \ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{class_eigen_1_1_ref}{Ref<ArrayXi>}}\ IndicesRef;}
\DoxyCodeLine{00108\ }
\DoxyCodeLine{00114\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a39514816d38f9c418cf3f3514b511c2c}{BDCSVD}}()\ :\ m\_algoswap(16),\ m\_isTranspose(false),\ m\_compU(false),\ m\_compV(false),\ m\_numIters(0)}
\DoxyCodeLine{00115\ \ \ \{\}}
\DoxyCodeLine{00116\ }
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00124\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a794635791982cbbfc3923fdb377eb5e5}{BDCSVD}}(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ p\_rows,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ p\_cols,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions\ =\ 0)}
\DoxyCodeLine{00125\ \ \ \ \ :\ m\_algoswap(16),\ m\_numIters(0)}
\DoxyCodeLine{00126\ \ \ \{}
\DoxyCodeLine{00127\ \ \ \ \ allocate(p\_rows,\ p\_cols,\ computationOptions);}
\DoxyCodeLine{00128\ \ \ \}}
\DoxyCodeLine{00129\ }
\DoxyCodeLine{00140\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a302746d9c534cd513c1df87c7ae4850d}{BDCSVD}}(\textcolor{keyword}{const}\ MatrixType\&\ matrix,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions\ =\ 0)}
\DoxyCodeLine{00141\ \ \ \ \ :\ m\_algoswap(16),\ m\_numIters(0)}
\DoxyCodeLine{00142\ \ \ \{}
\DoxyCodeLine{00143\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a52e3c627775010775c64d16a00cdb770}{compute}}(matrix,\ computationOptions);}
\DoxyCodeLine{00144\ \ \ \}}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00146\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d}{\string~BDCSVD}}()\ }
\DoxyCodeLine{00147\ \ \ \{}
\DoxyCodeLine{00148\ \ \ \}}
\DoxyCodeLine{00149\ \ \ }
\DoxyCodeLine{00160\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a39514816d38f9c418cf3f3514b511c2c}{BDCSVD}}\&\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a52e3c627775010775c64d16a00cdb770}{compute}}(\textcolor{keyword}{const}\ MatrixType\&\ matrix,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions);}
\DoxyCodeLine{00161\ }
\DoxyCodeLine{00168\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a39514816d38f9c418cf3f3514b511c2c}{BDCSVD}}\&\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a61880a5f6dbf7a14f91be80eaa3a22bc}{compute}}(\textcolor{keyword}{const}\ MatrixType\&\ matrix)}
\DoxyCodeLine{00169\ \ \ \{}
\DoxyCodeLine{00170\ \ \ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a52e3c627775010775c64d16a00cdb770}{compute}}(matrix,\ this-\/>m\_computationOptions);}
\DoxyCodeLine{00171\ \ \ \}}
\DoxyCodeLine{00172\ }
\DoxyCodeLine{00173\ \ \ \textcolor{keywordtype}{void}\ setSwitchSize(\textcolor{keywordtype}{int}\ s)\ }
\DoxyCodeLine{00174\ \ \ \{}
\DoxyCodeLine{00175\ \ \ \ \ eigen\_assert(s>3\ \&\&\ \textcolor{stringliteral}{"{}BDCSVD\ the\ size\ of\ the\ algo\ switch\ has\ to\ be\ greater\ than\ 3"{}});}
\DoxyCodeLine{00176\ \ \ \ \ m\_algoswap\ =\ s;}
\DoxyCodeLine{00177\ \ \ \}}
\DoxyCodeLine{00178\ \ }
\DoxyCodeLine{00179\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00180\ \ \ \textcolor{keywordtype}{void}\ allocate(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ \doxymbox{\hyperlink{struct_eigen_1_1_eigen_base_af1d12fdb3361e150427e1fd94ebb1f14}{rows}},\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ \doxymbox{\hyperlink{struct_eigen_1_1_eigen_base_a50c19c45f15acdfe1cb66ab5e879b8e3}{cols}},\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions);}
\DoxyCodeLine{00181\ \ \ \textcolor{keywordtype}{void}\ divide(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ lastCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstRowW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstColW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ shift);}
\DoxyCodeLine{00182\ \ \ \textcolor{keywordtype}{void}\ computeSVDofM(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ n,\ MatrixXr\&\ U,\ VectorType\&\ singVals,\ MatrixXr\&\ V);}
\DoxyCodeLine{00183\ \ \ \textcolor{keywordtype}{void}\ computeSingVals(\textcolor{keyword}{const}\ ArrayRef\&\ col0,\ \textcolor{keyword}{const}\ ArrayRef\&\ diag,\ \textcolor{keyword}{const}\ IndicesRef\&\ perm,\ VectorType\&\ singVals,\ ArrayRef\ shifts,\ ArrayRef\ mus);}
...
\DoxyCodeLine{00186\ \ \ \textcolor{keywordtype}{void}\ deflation43(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ shift,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ i,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ size);}
\DoxyCodeLine{00187\ \ \ \textcolor{keywordtype}{void}\ deflation44(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstColu\ ,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstColm,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstRowW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstColW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ i,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ j,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ size);}
\DoxyCodeLine{00188\ \ \ \textcolor{keywordtype}{void}\ deflation(\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ lastCol,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ k,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstRowW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ firstColW,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ shift);}
...
\DoxyCodeLine{00191\ \ \ \textcolor{keywordtype}{void}\ structured\_update(Block<MatrixXr,Dynamic,Dynamic>\ A,\ \textcolor{keyword}{const}\ MatrixXr\ \&B,\ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ n1);}
\DoxyCodeLine{00192\ \ \ \textcolor{keyword}{static}\ RealScalar\ secularEq(RealScalar\ x,\ \textcolor{keyword}{const}\ ArrayRef\&\ col0,\ \textcolor{keyword}{const}\ ArrayRef\&\ diag,\ \textcolor{keyword}{const}\ IndicesRef\ \&perm,\ \textcolor{keyword}{const}\ ArrayRef\&\ diagShifted,\ RealScalar\ shift);}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00195\ \ \ MatrixXr\ m\_naiveU,\ m\_naiveV;}
\DoxyCodeLine{00196\ \ \ MatrixXr\ m\_computed;}
\DoxyCodeLine{00197\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a6229a37997eca1072b52cca5ee7a2bec}{Index}}\ m\_nRec;}
\DoxyCodeLine{00198\ \ \ ArrayXr\ m\_workspace;}
\DoxyCodeLine{00199\ \ \ ArrayXi\ m\_workspaceI;}
\DoxyCodeLine{00200\ \ \ \textcolor{keywordtype}{int}\ m\_algoswap;}
\DoxyCodeLine{00201\ \ \ \textcolor{keywordtype}{bool}\ m\_isTranspose,\ m\_compU,\ m\_compV;}
\DoxyCodeLine{00202\ \ \ }
\DoxyCodeLine{00203\ \ \ \textcolor{keyword}{using\ }Base::m\_singularValues;}
\DoxyCodeLine{00204\ \ \ \textcolor{keyword}{using\ }Base::m\_diagSize;}
\DoxyCodeLine{00205\ \ \ \textcolor{keyword}{using\ }Base::m\_computeFullU;}
\DoxyCodeLine{00206\ \ \ \textcolor{keyword}{using\ }Base::m\_computeFullV;}
\DoxyCodeLine{00207\ \ \ \textcolor{keyword}{using\ }Base::m\_computeThinU;}
\DoxyCodeLine{00208\ \ \ \textcolor{keyword}{using\ }Base::m\_computeThinV;}
\DoxyCodeLine{00209\ \ \ \textcolor{keyword}{using\ }Base::m\_matrixU;}
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{using\ }Base::m\_matrixV;}
\DoxyCodeLine{00211\ \ \ \textcolor{keyword}{using\ }Base::m\_info;}
\DoxyCodeLine{00212\ \ \ \textcolor{keyword}{using\ }Base::m\_isInitialized;}
\DoxyCodeLine{00213\ \ \ \textcolor{keyword}{using\ }Base::m\_nonzeroSingularValues;}
\DoxyCodeLine{00214\ }
\DoxyCodeLine{00215\ \textcolor{keyword}{public}:\ \ }
\DoxyCodeLine{00216\ \ \ \textcolor{keywordtype}{int}\ m\_numIters;}
...
\DoxyCodeLine{00222\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::allocate(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ p\_rows,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ p\_cols,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions)}
\DoxyCodeLine{00223\ \{}
\DoxyCodeLine{00224\ \ \ m\_isTranspose\ =\ (p\_cols\ >\ p\_rows);}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00226\ \ \ \textcolor{keywordflow}{if}\ (Base::allocate(p\_rows,\ p\_cols,\ computationOptions))}
...
\DoxyCodeLine{00245\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a39514816d38f9c418cf3f3514b511c2c}{BDCSVD<MatrixType>}}\&\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a52e3c627775010775c64d16a00cdb770}{BDCSVD<MatrixType>::compute}}(\textcolor{keyword}{const}\ MatrixType\&\ matrix,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions)\ }
\DoxyCodeLine{00246\ \{}
...
\DoxyCodeLine{00252\ }
\DoxyCodeLine{00253\ \ \ \textcolor{keyword}{const}\ RealScalar\ considerZero\ =\ (std::numeric\_limits<RealScalar>::min)();}
\DoxyCodeLine{00254\ \ \ }
...
\DoxyCodeLine{00259\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_jacobi_s_v_d}{JacobiSVD<MatrixType>}}\ jsvd(matrix,computationOptions);}
\DoxyCodeLine{00260\ \ \ \ \ m\_isInitialized\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00261\ \ \ \ \ m\_info\ =\ jsvd.\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_a569913a15fa2f327121f155682368602}{info}}();}
\DoxyCodeLine{00262\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_info\ ==\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ ||\ m\_info\ ==\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}})\ \{}
\DoxyCodeLine{00263\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_a51fcc2fbadec89148a5e4222c77e35ec}{computeU}}())\ m\_matrixU\ =\ jsvd.\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_accbc8e3f9baab3a57a6eba8e4cc3ea27}{matrixU}}();}
\DoxyCodeLine{00264\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d_aea45b7e486d3333446b274f484b0c587}{computeV}}())\ m\_matrixV\ =\ jsvd.\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_af09f06357d7d7442f7ca7343713756fe}{matrixV}}();}
\DoxyCodeLine{00265\ \ \ \ \ \ \ m\_singularValues\ =\ jsvd.\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_ac44c307a70731003003faf3a9bdf14f6}{singularValues}}();}
\DoxyCodeLine{00266\ \ \ \ \ \ \ m\_nonzeroSingularValues\ =\ jsvd.\doxymbox{\hyperlink{class_eigen_1_1_s_v_d_base_afe8a555f38393a319a71ec0f0331c9ef}{nonzeroSingularValues}}();}
\DoxyCodeLine{00267\ \ \ \ \ \}}
...
\DoxyCodeLine{00272\ \ \ RealScalar\ scale\ =\ matrix.cwiseAbs().template\ maxCoeff<PropagateNaN>();}
\DoxyCodeLine{00273\ \ \ \textcolor{keywordflow}{if}\ (!(numext::isfinite)(scale))\ \{}
\DoxyCodeLine{00274\ \ \ \ \ m\_isInitialized\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00275\ \ \ \ \ m\_info\ =\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea580b2a3cafe585691e789f768fb729bf}{InvalidInput}};}
\DoxyCodeLine{00276\ \ \ \ \ \textcolor{keywordflow}{return}\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00277\ \ \ \}}
\DoxyCodeLine{00278\ }
\DoxyCodeLine{00279\ \ \ \textcolor{keywordflow}{if}(scale==Literal(0))\ scale\ =\ Literal(1);}
\DoxyCodeLine{00280\ \ \ MatrixX\ copy;}
...
\DoxyCodeLine{00286\ \ \ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_upper_bidiagonalization}{internal::UpperBidiagonalization<MatrixX>}}\ bid(copy);}
\DoxyCodeLine{00287\ }
...
\DoxyCodeLine{00292\ \ \ m\_computed.topRows(m\_diagSize)\ =\ bid.bidiagonal().toDenseMatrix().transpose();}
\DoxyCodeLine{00293\ \ \ m\_computed.template\ bottomRows<1>().\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac21ad5f989f320e46958b75ac8d9a1da}{setZero}}();}
\DoxyCodeLine{00294\ \ \ divide(0,\ m\_diagSize\ -\/\ 1,\ 0,\ 0,\ 0);}
\DoxyCodeLine{00295\ \ \ \textcolor{keywordflow}{if}\ (m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ \&\&\ m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}})\ \{}
...
\DoxyCodeLine{00301\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i=0;\ i<m\_diagSize;\ i++)}
\DoxyCodeLine{00302\ \ \ \{}
\DoxyCodeLine{00303\ \ \ \ \ RealScalar\ a\ =\ abs(m\_computed.coeff(i,\ i));}
\DoxyCodeLine{00304\ \ \ \ \ m\_singularValues.coeffRef(i)\ =\ a\ *\ scale;}
\DoxyCodeLine{00305\ \ \ \ \ \textcolor{keywordflow}{if}\ (a<considerZero)}
\DoxyCodeLine{00306\ \ \ \ \ \{}
\DoxyCodeLine{00307\ \ \ \ \ \ \ m\_nonzeroSingularValues\ =\ i;}
\DoxyCodeLine{00308\ \ \ \ \ \ \ m\_singularValues.tail(m\_diagSize\ -\/\ i\ -\/\ 1).setZero();}
\DoxyCodeLine{00309\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00310\ \ \ \ \ \}}
\DoxyCodeLine{00311\ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (i\ ==\ m\_diagSize\ -\/\ 1)}
\DoxyCodeLine{00312\ \ \ \ \ \{}
\DoxyCodeLine{00313\ \ \ \ \ \ \ m\_nonzeroSingularValues\ =\ i\ +\ 1;}
...
\DoxyCodeLine{00322\ \ \ \textcolor{keywordflow}{if}(m\_isTranspose)\ copyUV(bid.householderV(),\ bid.householderU(),\ m\_naiveV,\ m\_naiveU);}
\DoxyCodeLine{00323\ \ \ \textcolor{keywordflow}{else}\ \ \ \ \ \ \ \ \ \ \ \ \ \ copyUV(bid.householderU(),\ bid.householderV(),\ m\_naiveU,\ m\_naiveV);}
\DoxyCodeLine{00324\ }
...
\DoxyCodeLine{00332\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::copyUV(\textcolor{keyword}{const}\ HouseholderU\ \&householderU,\ \textcolor{keyword}{const}\ HouseholderV\ \&householderV,\ \textcolor{keyword}{const}\ NaiveU\ \&naiveU,\ \textcolor{keyword}{const}\ NaiveV\ \&naiveV)}
\DoxyCodeLine{00333\ \{}
...
\DoxyCodeLine{00336\ \ \ \{}
\DoxyCodeLine{00337\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ Ucols\ =\ m\_computeThinU\ ?\ m\_diagSize\ :\ householderU.cols();}
\DoxyCodeLine{00338\ \ \ \ \ m\_matrixU\ =\ MatrixX::Identity(householderU.cols(),\ Ucols);}
\DoxyCodeLine{00339\ \ \ \ \ m\_matrixU.topLeftCorner(m\_diagSize,\ m\_diagSize)\ =\ naiveV.template\ cast<Scalar>().topLeftCorner(m\_diagSize,\ m\_diagSize);}
...
\DoxyCodeLine{00343\ \ \ \{}
\DoxyCodeLine{00344\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ Vcols\ =\ m\_computeThinV\ ?\ m\_diagSize\ :\ householderV.cols();}
\DoxyCodeLine{00345\ \ \ \ \ m\_matrixV\ =\ MatrixX::Identity(householderV.cols(),\ Vcols);}
\DoxyCodeLine{00346\ \ \ \ \ m\_matrixV.topLeftCorner(m\_diagSize,\ m\_diagSize)\ =\ naiveU.template\ cast<Scalar>().topLeftCorner(m\_diagSize,\ m\_diagSize);}
...
\DoxyCodeLine{00360\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::structured\_update(\doxymbox{\hyperlink{class_eigen_1_1_block}{Block<MatrixXr,Dynamic,Dynamic>}}\ A,\ \textcolor{keyword}{const}\ MatrixXr\ \&B,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n1)}
\DoxyCodeLine{00361\ \{}
\DoxyCodeLine{00362\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ A.rows();}
\DoxyCodeLine{00363\ \ \ \textcolor{keywordflow}{if}(n>100)}
\DoxyCodeLine{00364\ \ \ \{}
...
\DoxyCodeLine{00367\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n2\ =\ n\ -\/\ n1;}
\DoxyCodeLine{00368\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<MatrixXr>}}\ A1(m\_workspace.data()\ \ \ \ \ \ ,\ n1,\ n);}
\DoxyCodeLine{00369\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<MatrixXr>}}\ A2(m\_workspace.data()+\ n1*n,\ n2,\ n);}
\DoxyCodeLine{00370\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<MatrixXr>}}\ B1(m\_workspace.data()+\ \ n*n,\ n,\ \ n);}
\DoxyCodeLine{00371\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<MatrixXr>}}\ B2(m\_workspace.data()+2*n*n,\ n,\ \ n);}
\DoxyCodeLine{00372\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k1=0,\ k2=0;}
\DoxyCodeLine{00373\ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;\ j<n;\ ++j)}
\DoxyCodeLine{00374\ \ \ \ \ \{}
\DoxyCodeLine{00375\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ (A.col(j).head(n1).array()!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)).\doxymbox{\hyperlink{class_eigen_1_1_dense_base_ae2fd88cfd0f2bf9cc493d0a29cbc8695}{any}}()\ )}
\DoxyCodeLine{00376\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00377\ \ \ \ \ \ \ \ \ A1.col(k1)\ =\ A.col(j).head(n1);}
\DoxyCodeLine{00378\ \ \ \ \ \ \ \ \ B1.row(k1)\ =\ B.row(j);}
\DoxyCodeLine{00379\ \ \ \ \ \ \ \ \ ++k1;}
\DoxyCodeLine{00380\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00381\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ (A.col(j).tail(n2).array()!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)).\doxymbox{\hyperlink{class_eigen_1_1_dense_base_ae2fd88cfd0f2bf9cc493d0a29cbc8695}{any}}()\ )}
\DoxyCodeLine{00382\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00393\ \ \ \{}
\DoxyCodeLine{00394\ \ \ \ \ Map<MatrixXr,Aligned>\ tmp(m\_workspace.data(),n,n);}
...
\DoxyCodeLine{00411\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::divide(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ lastCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstRowW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstColW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ shift)}
\DoxyCodeLine{00412\ \{}
...
\DoxyCodeLine{00417\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ lastCol\ -\/\ firstCol\ +\ 1;}
\DoxyCodeLine{00418\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k\ =\ n/2;}
...
\DoxyCodeLine{00424\ \ \ VectorType\ l,\ f;}
...
\DoxyCodeLine{00427\ \ \ \textcolor{keywordflow}{if}\ (n\ <\ m\_algoswap)}
\DoxyCodeLine{00428\ \ \ \{}
\DoxyCodeLine{00429\ \ \ \ \ \textcolor{comment}{//\ FIXME\ this\ line\ involves\ temporaries}}
\DoxyCodeLine{00430\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_jacobi_s_v_d}{JacobiSVD<MatrixXr>}}\ b(m\_computed.block(firstCol,\ firstCol,\ n\ +\ 1,\ n),\ \doxymbox{\hyperlink{group__enums_ggae3e239fb70022eb8747994cf5d68b4a9a9fa9302d510cee20c26311154937e23f}{ComputeFullU}}\ |\ (m\_compV\ ?\ \doxymbox{\hyperlink{group__enums_ggae3e239fb70022eb8747994cf5d68b4a9a36581f7c662f7def31efd500c284f930}{ComputeFullV}}\ :\ 0));}
\DoxyCodeLine{00431\ \ \ \ \ m\_info\ =\ b.info();}
\DoxyCodeLine{00432\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ \&\&\ m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}})\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00433\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_compU)}
\DoxyCodeLine{00434\ \ \ \ \ \ \ m\_naiveU.block(firstCol,\ firstCol,\ n\ +\ 1,\ n\ +\ 1).real()\ =\ b.matrixU();}
\DoxyCodeLine{00435\ \ \ \ \ \textcolor{keywordflow}{else}\ }
\DoxyCodeLine{00436\ \ \ \ \ \{}
\DoxyCodeLine{00437\ \ \ \ \ \ \ m\_naiveU.row(0).segment(firstCol,\ n\ +\ 1).real()\ =\ b.matrixU().row(0);}
\DoxyCodeLine{00438\ \ \ \ \ \ \ m\_naiveU.row(1).segment(firstCol,\ n\ +\ 1).real()\ =\ b.matrixU().row(n);}
\DoxyCodeLine{00439\ \ \ \ \ \}}
\DoxyCodeLine{00440\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ m\_naiveV.block(firstRowW,\ firstColW,\ n,\ n).real()\ =\ b.matrixV();}
\DoxyCodeLine{00441\ \ \ \ \ m\_computed.block(firstCol\ +\ shift,\ firstCol\ +\ shift,\ n\ +\ 1,\ n).setZero();}
\DoxyCodeLine{00442\ \ \ \ \ m\_computed.diagonal().segment(firstCol\ +\ shift,\ n)\ =\ b.singularValues().head(n);}
...
\DoxyCodeLine{00452\ \ \ \textcolor{keywordflow}{if}\ (m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ \&\&\ m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}})\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00453\ \ \ divide(firstCol,\ k\ -\/\ 1\ +\ firstCol,\ firstRowW,\ firstColW\ +\ 1,\ shift\ +\ 1);}
\DoxyCodeLine{00454\ \ \ \textcolor{keywordflow}{if}\ (m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea671a2aeb0f527802806a441d58a80fcf}{Success}}\ \&\&\ m\_info\ !=\ \doxymbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea6a68dfb88a8336108a30588bdf356c57}{NoConvergence}})\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00455\ }
...
\DoxyCodeLine{00465\ \ \ \}}
\DoxyCodeLine{00466\ \ \ r0\ =\ sqrt((abs(alphaK\ *\ lambda)\ *\ abs(alphaK\ *\ lambda))\ +\ abs(betaK\ *\ phi)\ *\ abs(betaK\ *\ phi));}
\DoxyCodeLine{00467\ \ \ \textcolor{keywordflow}{if}\ (m\_compU)}
\DoxyCodeLine{00468\ \ \ \{}
\DoxyCodeLine{00469\ \ \ \ \ l\ =\ m\_naiveU.row(firstCol\ +\ k).segment(firstCol,\ k);}
\DoxyCodeLine{00470\ \ \ \ \ f\ =\ m\_naiveU.row(firstCol\ +\ k\ +\ 1).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k\ -\/\ 1);}
\DoxyCodeLine{00471\ \ \ \}\ }
\DoxyCodeLine{00472\ \ \ \textcolor{keywordflow}{else}\ }
\DoxyCodeLine{00473\ \ \ \{}
\DoxyCodeLine{00474\ \ \ \ \ l\ =\ m\_naiveU.row(1).segment(firstCol,\ k);}
\DoxyCodeLine{00475\ \ \ \ \ f\ =\ m\_naiveU.row(0).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k\ -\/\ 1);}
\DoxyCodeLine{00476\ \ \ \}}
\DoxyCodeLine{00477\ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ m\_naiveV(firstRowW+k,\ firstColW)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(1);}
\DoxyCodeLine{00478\ \ \ \textcolor{keywordflow}{if}\ (r0<considerZero)}
\DoxyCodeLine{00479\ \ \ \{}
\DoxyCodeLine{00480\ \ \ \ \ c0\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(1);}
\DoxyCodeLine{00481\ \ \ \ \ s0\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{00482\ \ \ \}}
...
\DoxyCodeLine{00499\ \ \ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ firstCol\ +\ k\ -\/\ 1;\ i\ >=\ firstCol;\ i-\/-\/)\ }
\DoxyCodeLine{00500\ \ \ \ \ \ \ m\_naiveU.col(i\ +\ 1).segment(firstCol,\ k\ +\ 1)\ =\ m\_naiveU.col(i).segment(firstCol,\ k\ +\ 1);}
...
\DoxyCodeLine{00506\ \ \ \ \ m\_naiveU.col(firstCol).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k)\ =\ m\_naiveU.col(lastCol\ +\ 1).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k)\ *\ s0;\ }
\DoxyCodeLine{00507\ \ \ \ \ \textcolor{comment}{//\ q2\ *=\ c0}}
\DoxyCodeLine{00508\ \ \ \ \ m\_naiveU.col(lastCol\ +\ 1).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k)\ *=\ c0;}
\DoxyCodeLine{00509\ \ \ \}\ }
...
\DoxyCodeLine{00514\ \ \ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ firstCol\ +\ k\ -\/\ 1;\ i\ >=\ firstCol;\ i-\/-\/)\ }
\DoxyCodeLine{00515\ \ \ \ \ \ \ m\_naiveU(0,\ i\ +\ 1)\ =\ m\_naiveU(0,\ i);}
...
\DoxyCodeLine{00525\ \ \ \ \ m\_naiveU.row(0).segment(firstCol\ +\ k\ +\ 1,\ n\ -\/\ k\ -\/\ 1).setZero();}
\DoxyCodeLine{00526\ \ \ \}}
\DoxyCodeLine{00527\ \ \ }
...
\DoxyCodeLine{00536\ \ \ m\_computed.col(firstCol\ +\ shift).segment(firstCol\ +\ shift\ +\ k\ +\ 1,\ n\ -\/\ k\ -\/\ 1)\ =\ betaK\ *\ f.transpose().real();}
\DoxyCodeLine{00537\ }
\DoxyCodeLine{00538\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{00539\ \ \ ArrayXr\ tmp1\ =\ (m\_computed.block(firstCol+shift,\ firstCol+shift,\ n,\ n)).jacobiSvd().singularValues();}
...
\DoxyCodeLine{00544\ \ \ ArrayXr\ tmp2\ =\ (m\_computed.block(firstCol+shift,\ firstCol+shift,\ n,\ n)).jacobiSvd().singularValues();}
...
\DoxyCodeLine{00558\ \ \ computeSVDofM(firstCol\ +\ shift,\ n,\ UofSVD,\ singVals,\ VofSVD);}
\DoxyCodeLine{00559\ \ \ }
...
\DoxyCodeLine{00566\ \ \ \ \ structured\_update(m\_naiveU.block(firstCol,\ firstCol,\ n\ +\ 1,\ n\ +\ 1),\ UofSVD,\ (n+2)/2);}
\DoxyCodeLine{00567\ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00568\ \ \ \{}
\DoxyCodeLine{00569\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<Matrix<RealScalar,2,Dynamic>}},\doxymbox{\hyperlink{group__enums_gga45fe06e29902b7a2773de05ba27b47a1ae12d0f8f869c40c76128260af2242bc8}{Aligned}}>\ tmp(m\_workspace.data(),2,n+1);}
\DoxyCodeLine{00570\ \ \ \ \ tmp.noalias()\ =\ m\_naiveU.middleCols(firstCol,\ n+1)\ *\ UofSVD;}
\DoxyCodeLine{00571\ \ \ \ \ m\_naiveU.middleCols(firstCol,\ n\ +\ 1)\ =\ tmp;}
\DoxyCodeLine{00572\ \ \ \}}
\DoxyCodeLine{00573\ \ \ }
\DoxyCodeLine{00574\ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ \ structured\_update(m\_naiveV.block(firstRowW,\ firstColW,\ n,\ n),\ VofSVD,\ (n+1)/2);}
\DoxyCodeLine{00575\ \ \ }
...
\DoxyCodeLine{00581\ \ \ }
\DoxyCodeLine{00582\ \ \ m\_computed.block(firstCol\ +\ shift,\ firstCol\ +\ shift,\ n,\ n).setZero();}
\DoxyCodeLine{00583\ \ \ m\_computed.block(firstCol\ +\ shift,\ firstCol\ +\ shift,\ n,\ n).diagonal()\ =\ singVals;}
...
\DoxyCodeLine{00595\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::computeSVDofM(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ n,\ MatrixXr\&\ U,\ VectorType\&\ singVals,\ MatrixXr\&\ V)}
\DoxyCodeLine{00596\ \{}
...
\DoxyCodeLine{00599\ \ \ ArrayRef\ col0\ =\ m\_computed.col(firstCol).segment(firstCol,\ n);}
\DoxyCodeLine{00600\ \ \ m\_workspace.head(n)\ =\ \ m\_computed.block(firstCol,\ firstCol,\ n,\ n).diagonal();}
\DoxyCodeLine{00601\ \ \ ArrayRef\ diag\ =\ m\_workspace.head(n);}
\DoxyCodeLine{00602\ \ \ diag(0)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{00603\ }
\DoxyCodeLine{00604\ \ \ \textcolor{comment}{//\ Allocate\ space\ for\ singular\ values\ and\ vectors}}
\DoxyCodeLine{00605\ \ \ singVals.resize(n);}
\DoxyCodeLine{00606\ \ \ U.resize(n+1,\ n+1);}
\DoxyCodeLine{00607\ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ V.resize(n,\ n);}
\DoxyCodeLine{00608\ }
...
\DoxyCodeLine{00617\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actual\_n\ =\ n;}
\DoxyCodeLine{00618\ \ \ \textcolor{keywordflow}{while}(actual\_n>1\ \&\&\ diag(actual\_n-\/1)==\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))\ \{-\/-\/actual\_n;\ eigen\_internal\_assert(col0(actual\_n)==\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0));\ \}}
\DoxyCodeLine{00619\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ 0;\ \textcolor{comment}{//\ size\ of\ the\ deflated\ problem}}
\DoxyCodeLine{00620\ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k=0;k<actual\_n;++k)}
\DoxyCodeLine{00621\ \ \ \ \ \textcolor{keywordflow}{if}(abs(col0(k))>considerZero)}
\DoxyCodeLine{00622\ \ \ \ \ \ \ m\_workspaceI(m++)\ =\ k;}
\DoxyCodeLine{00623\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<ArrayXi>}}\ perm(m\_workspaceI.data(),m);}
\DoxyCodeLine{00624\ \ \ }
\DoxyCodeLine{00625\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<ArrayXr>}}\ shifts(m\_workspace.data()+1*n,\ n);}
\DoxyCodeLine{00626\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<ArrayXr>}}\ mus(m\_workspace.data()+2*n,\ n);}
\DoxyCodeLine{00627\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<ArrayXr>}}\ zhat(m\_workspace.data()+3*n,\ n);}
\DoxyCodeLine{00628\ }
...
\DoxyCodeLine{00639\ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}\ \ j:\ \ \ \ \ \ \ \ "{}}\ <<\ (m\_computed.block(firstCol,\ firstCol,\ n,\ n)).jacobiSvd().singularValues().transpose().reverse()\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n\(\backslash\)n"{}};}
...
\DoxyCodeLine{00688\ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=0;\ i<actual\_n-\/1;\ ++i)}
\DoxyCodeLine{00689\ \ \ \{}
\DoxyCodeLine{00690\ \ \ \ \ \textcolor{keywordflow}{if}(singVals(i)>singVals(i+1))}
\DoxyCodeLine{00691\ \ \ \ \ \{}
\DoxyCodeLine{00692\ \ \ \ \ \ \ \textcolor{keyword}{using\ }std::swap;}
\DoxyCodeLine{00693\ \ \ \ \ \ \ swap(singVals(i),singVals(i+1));}
\DoxyCodeLine{00694\ \ \ \ \ \ \ U.col(i).swap(U.col(i+1));}
\DoxyCodeLine{00695\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(m\_compV)\ V.col(i).swap(V.col(i+1));}
\DoxyCodeLine{00696\ \ \ \ \ \}}
\DoxyCodeLine{00697\ \ \ \}}
\DoxyCodeLine{00698\ }
...
\DoxyCodeLine{00715\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_jacobi_s_v_d}{JacobiSVD<MatrixXr>}}\ jsvd(m\_computed.block(firstCol,\ firstCol,\ n,\ n)\ );}
...
\DoxyCodeLine{00723\ \textcolor{keyword}{typename}\ BDCSVD<MatrixType>::RealScalar\ BDCSVD<MatrixType>::secularEq(RealScalar\ mu,\ \textcolor{keyword}{const}\ ArrayRef\&\ col0,\ \textcolor{keyword}{const}\ ArrayRef\&\ diag,\ \textcolor{keyword}{const}\ IndicesRef\ \&perm,\ \textcolor{keyword}{const}\ ArrayRef\&\ diagShifted,\ RealScalar\ shift)}
\DoxyCodeLine{00724\ \{}
\DoxyCodeLine{00725\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ perm.size();}
\DoxyCodeLine{00726\ \ \ RealScalar\ res\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(1);}
\DoxyCodeLine{00727\ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=0;\ i<m;\ ++i)}
\DoxyCodeLine{00728\ \ \ \{}
\DoxyCodeLine{00729\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ perm(i);}
...
\DoxyCodeLine{00745\ }
\DoxyCodeLine{00746\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ col0.size();}
\DoxyCodeLine{00747\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actual\_n\ =\ n;}
...
\DoxyCodeLine{00750\ \ \ \textcolor{keywordflow}{while}(actual\_n>1\ \&\&\ col0(actual\_n-\/1)==\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))\ -\/-\/actual\_n;}
\DoxyCodeLine{00751\ }
\DoxyCodeLine{00752\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k\ =\ 0;\ k\ <\ n;\ ++k)}
\DoxyCodeLine{00753\ \ \ \{}
\DoxyCodeLine{00754\ \ \ \ \ \textcolor{keywordflow}{if}\ (col0(k)\ ==\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ||\ actual\_n==1)}
\DoxyCodeLine{00755\ \ \ \ \ \{}
...
\DoxyCodeLine{00759\ \ \ \ \ \ \ mus(k)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
...
\DoxyCodeLine{00774\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ l\ =\ k+1;}
\DoxyCodeLine{00775\ \ \ \ \ \ \ \textcolor{keywordflow}{while}(col0(l)==\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))\ \{\ ++l;\ eigen\_internal\_assert(l<actual\_n);\ \}}
...
\DoxyCodeLine{00780\ \ \ \ \ RealScalar\ mid\ =\ left\ +\ (right-\/left)\ /\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(2);}
\DoxyCodeLine{00781\ \ \ \ \ RealScalar\ fMid\ =\ secularEq(mid,\ col0,\ diag,\ perm,\ diag,\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0));}
...
\DoxyCodeLine{00800\ \ \ \ \ RealScalar\ shift\ =\ (k\ ==\ actual\_n-\/1\ ||\ fMid\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))\ ?\ left\ :\ right;}
\DoxyCodeLine{00801\ \ \ \ \ }
\DoxyCodeLine{00802\ \ \ \ \ \textcolor{comment}{//\ measure\ everything\ relative\ to\ shift}}
\DoxyCodeLine{00803\ \ \ \ \ \doxymbox{\hyperlink{class_eigen_1_1_map}{Map<ArrayXr>}}\ diagShifted(m\_workspace.data()+4*n,\ n);}
...
\DoxyCodeLine{00816\ \ \ \ \ \ \ \ \ shift\ =\ \ fMidShifted\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ?\ left\ :\ right;}
...
\DoxyCodeLine{00837\ \ \ \ \ \textcolor{keywordflow}{if}\ (abs(fPrev)\ <\ abs(fCur))}
\DoxyCodeLine{00838\ \ \ \ \ \{}
...
\DoxyCodeLine{00845\ \ \ \ \ \textcolor{keywordtype}{bool}\ useBisection\ =\ fPrev*fCur>\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{00846\ \ \ \ \ \textcolor{keywordflow}{while}\ (fCur!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ \&\&\ abs(muCur\ -\/\ muPrev)\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(8)\ *\ NumTraits<RealScalar>::epsilon()\ *\ numext::maxi<RealScalar>(abs(muCur),\ abs(muPrev))\ \&\&\ abs(fCur\ -\/\ fPrev)>NumTraits<RealScalar>::epsilon()\ \&\&\ !useBisection)}
\DoxyCodeLine{00847\ \ \ \ \ \{}
...
\DoxyCodeLine{00851\ \ \ \ \ \ \ RealScalar\ a\ =\ (fCur\ -\/\ fPrev)\ /\ (\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(1)/muCur\ -\/\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(1)/muPrev);}
\DoxyCodeLine{00852\ \ \ \ \ \ \ RealScalar\ b\ =\ fCur\ -\/\ a\ /\ muCur;}
\DoxyCodeLine{00853\ \ \ \ \ \ \ \textcolor{comment}{//\ And\ find\ mu\ such\ that\ f(mu)==0:}}
\DoxyCodeLine{00854\ \ \ \ \ \ \ RealScalar\ muZero\ =\ -\/a/b;}
...
\DoxyCodeLine{00858\ \ \ \ \ \ \ assert((numext::isfinite)(fZero));}
...
\DoxyCodeLine{00865\ \ \ \ \ \ \ }
\DoxyCodeLine{00866\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (shift\ ==\ left\ \ \&\&\ (muCur\ <\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ||\ muCur\ >\ right\ -\/\ left))\ useBisection\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00867\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (shift\ ==\ right\ \&\&\ (muCur\ <\ -\/(right\ -\/\ left)\ ||\ muCur\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)))\ useBisection\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00868\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (abs(fCur)>abs(fPrev))\ useBisection\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00869\ \ \ \ \ \}}
\DoxyCodeLine{00870\ }
...
\DoxyCodeLine{00882\ \ \ \ \ \ \ \ \ leftShifted\ =\ numext::maxi<RealScalar>(\ (std::numeric\_limits<RealScalar>::min)(),\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(2)\ *\ abs(col0(k))\ /\ sqrt((std::numeric\_limits<RealScalar>::max)())\ );}
\DoxyCodeLine{00883\ }
\DoxyCodeLine{00884\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ check\ that\ we\ did\ it\ right:}}
\DoxyCodeLine{00885\ \ \ \ \ \ \ \ \ eigen\_internal\_assert(\ (numext::isfinite)(\ (col0(k)/leftShifted)*(col0(k)/(diag(k)+shift+leftShifted))\ )\ );}
...
\DoxyCodeLine{00893\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(k+1<n)}
\DoxyCodeLine{00894\ \ \ \ \ \ \ \ \ \ \ rightShifted\ =\ -\/numext::maxi<RealScalar>(\ (std::numeric\_limits<RealScalar>::min)(),\ abs(col0(k+1))\ /\ sqrt((std::numeric\_limits<RealScalar>::max)())\ );}
...
\DoxyCodeLine{00900\ \ \ \ \ \ \ eigen\_internal\_assert(fLeft<\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0));}
\DoxyCodeLine{00901\ }
...
\DoxyCodeLine{00907\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!(numext::isfinite)(fLeft))}
...
\DoxyCodeLine{00909\ \ \ \ \ \ \ assert((numext::isfinite)(fLeft));}
\DoxyCodeLine{00910\ }
\DoxyCodeLine{00911\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!(numext::isfinite)(fRight))}
...
\DoxyCodeLine{00927\ \ \ \ \ \ \ eigen\_internal\_assert(fLeft\ *\ fRight\ <\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0));}
\DoxyCodeLine{00928\ }
\DoxyCodeLine{00929\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(fLeft<\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))}
\DoxyCodeLine{00930\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00931\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{while}\ (rightShifted\ -\/\ leftShifted\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(2)\ *\ NumTraits<RealScalar>::epsilon()\ *\ numext::maxi<RealScalar>(abs(leftShifted),\ abs(rightShifted)))}
\DoxyCodeLine{00932\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00933\ \ \ \ \ \ \ \ \ \ \ RealScalar\ midShifted\ =\ (leftShifted\ +\ rightShifted)\ /\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(2);}
\DoxyCodeLine{00934\ \ \ \ \ \ \ \ \ \ \ fMid\ =\ secularEq(midShifted,\ col0,\ diag,\ perm,\ diagShifted,\ shift);}
\DoxyCodeLine{00935\ \ \ \ \ \ \ \ \ \ \ eigen\_internal\_assert((numext::isfinite)(fMid));}
\DoxyCodeLine{00936\ }
\DoxyCodeLine{00937\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (fLeft\ *\ fMid\ <\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))}
\DoxyCodeLine{00938\ \ \ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00945\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00946\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00947\ \ \ \ \ \ \ \ \ muCur\ =\ (leftShifted\ +\ rightShifted)\ /\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(2);}
\DoxyCodeLine{00948\ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00966\ \ \ \ \ \textcolor{keywordflow}{if}(k+1<n)}
...
\DoxyCodeLine{00990\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ col0.size();}
\DoxyCodeLine{00991\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ perm.size();}
...
\DoxyCodeLine{00996\ \ \ \}}
\DoxyCodeLine{00997\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lastIdx\ =\ perm(m-\/1);}
\DoxyCodeLine{00998\ \ \ \textcolor{comment}{//\ The\ offset\ permits\ to\ skip\ deflated\ entries\ while\ computing\ zhat}}
\DoxyCodeLine{00999\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k\ =\ 0;\ k\ <\ n;\ ++k)}
\DoxyCodeLine{01000\ \ \ \{}
\DoxyCodeLine{01001\ \ \ \ \ \textcolor{keywordflow}{if}\ (col0(k)\ ==\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))\ \textcolor{comment}{//\ deflated}}
\DoxyCodeLine{01002\ \ \ \ \ \ \ zhat(k)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
...
\DoxyCodeLine{01016\ }
\DoxyCodeLine{01017\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ l\ =\ 0;\ l<m;\ ++l)}
\DoxyCodeLine{01018\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01019\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ perm(l);}
\DoxyCodeLine{01020\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(i!=k)}
\DoxyCodeLine{01021\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{01022\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_SANITY\_CHECKS}}
\DoxyCodeLine{01023\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(i>=k\ \&\&\ (l==0\ ||\ l-\/1>=m))}
\DoxyCodeLine{01024\ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{01025\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}Error\ in\ perturbCol0\(\backslash\)n"{}};}
\DoxyCodeLine{01026\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}\ \ "{}}\ <<\ k\ <<\ \textcolor{stringliteral}{"{}/"{}}\ <<\ n\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ \ <<\ l\ <<\ \textcolor{stringliteral}{"{}/"{}}\ <<\ m\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{}/"{}}\ <<\ n\ <<\ \textcolor{stringliteral}{"{}\ ;\ "{}}\ <<\ col0(k)\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ <<\ diag(k)\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ \ <<\ \ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01027\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}\ \ "{}}\ <<diag(i)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01028\ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ (i<k\ \textcolor{comment}{/*||\ l==0*/})\ ?\ i\ :\ perm(l-\/1);}
\DoxyCodeLine{01029\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}\ \ "{}}\ <<\ \textcolor{stringliteral}{"{}j="{}}\ <<\ j\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01030\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01031\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01032\ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ i<k\ ?\ i\ :\ perm(l-\/1);}
\DoxyCodeLine{01033\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_SANITY\_CHECKS}}
\DoxyCodeLine{01034\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!(dk!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ||\ diag(i)!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)))}
\DoxyCodeLine{01035\ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{01036\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}k="{}}\ <<\ k\ <<\ \textcolor{stringliteral}{"{},\ i="{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{},\ l="{}}\ <<\ l\ <<\ \textcolor{stringliteral}{"{},\ perm.size()="{}}\ <<\ perm.size()\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01037\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01038\ \ \ \ \ \ \ \ \ \ \ assert(dk!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ||\ diag(i)!=\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0));}
\DoxyCodeLine{01039\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01040\ \ \ \ \ \ \ \ \ \ \ prod\ *=\ ((singVals(j)+dk)\ /\ ((diag(i)+dk)))\ *\ ((mus(j)+(shifts(j)-\/dk))\ /\ ((diag(i)-\/dk)));}
...
\DoxyCodeLine{01045\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(i!=k\ \&\&\ numext::abs(((singVals(j)+dk)*(mus(j)+(shifts(j)-\/dk)))/((diag(i)+dk)*(diag(i)-\/dk))\ -\/\ 1)\ >\ 0.9\ )}
\DoxyCodeLine{01046\ \ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}\ \ \ \ \ "{}}\ <<\ ((singVals(j)+dk)*(mus(j)+(shifts(j)-\/dk)))/((diag(i)+dk)*(diag(i)-\/dk))\ <<\ \textcolor{stringliteral}{"{}\ ==\ ("{}}\ <<\ (singVals(j)+dk)\ <<\ \textcolor{stringliteral}{"{}\ *\ "{}}\ <<\ (mus(j)+(shifts(j)-\/dk))}
\DoxyCodeLine{01047\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{})\ /\ ("{}}\ <<\ (diag(i)+dk)\ <<\ \textcolor{stringliteral}{"{}\ *\ "{}}\ <<\ (diag(i)-\/dk)\ <<\ \textcolor{stringliteral}{"{})\(\backslash\)n"{}};}
...
\DoxyCodeLine{01054\ \ \ \ \ \ \ RealScalar\ tmp\ =\ sqrt(prod);}
\DoxyCodeLine{01055\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_SANITY\_CHECKS}}
\DoxyCodeLine{01056\ \ \ \ \ \ \ assert((numext::isfinite)(tmp));}
\DoxyCodeLine{01057\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01058\ \ \ \ \ \ \ zhat(k)\ =\ col0(k)\ >\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0)\ ?\ RealScalar(tmp)\ :\ RealScalar(-\/tmp);}
\DoxyCodeLine{01059\ \ \ \ \ \}}
\DoxyCodeLine{01060\ \ \ \}}
\DoxyCodeLine{01061\ \}}
\DoxyCodeLine{01062\ }
...
\DoxyCodeLine{01068\ \{}
\DoxyCodeLine{01069\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ zhat.size();}
\DoxyCodeLine{01070\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ perm.size();}
\DoxyCodeLine{01071\ \ \ }
\DoxyCodeLine{01072\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k\ =\ 0;\ k\ <\ n;\ ++k)}
\DoxyCodeLine{01073\ \ \ \{}
\DoxyCodeLine{01074\ \ \ \ \ \textcolor{keywordflow}{if}\ (zhat(k)\ ==\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))}
\DoxyCodeLine{01075\ \ \ \ \ \{}
\DoxyCodeLine{01076\ \ \ \ \ \ \ U.col(k)\ =\ VectorType::Unit(n+1,\ k);}
\DoxyCodeLine{01077\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ V.col(k)\ =\ VectorType::Unit(n,\ k);}
\DoxyCodeLine{01078\ \ \ \ \ \}}
\DoxyCodeLine{01079\ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{01080\ \ \ \ \ \{}
\DoxyCodeLine{01081\ \ \ \ \ \ \ U.col(k).setZero();}
\DoxyCodeLine{01082\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ l=0;l<m;++l)}
\DoxyCodeLine{01083\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01084\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ perm(l);}
\DoxyCodeLine{01085\ \ \ \ \ \ \ \ \ U(i,k)\ =\ zhat(i)/(((diag(i)\ -\/\ shifts(k))\ -\/\ mus(k))\ )/(\ (diag(i)\ +\ singVals[k]));}
\DoxyCodeLine{01086\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01087\ \ \ \ \ \ \ U(n,k)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
...
\DoxyCodeLine{01093\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ l=1;l<m;++l)}
\DoxyCodeLine{01094\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{01095\ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ perm(l);}
\DoxyCodeLine{01096\ \ \ \ \ \ \ \ \ \ \ V(i,k)\ =\ diag(i)\ *\ zhat(i)\ /\ (((diag(i)\ -\/\ shifts(k))\ -\/\ mus(k))\ )/(\ (diag(i)\ +\ singVals[k]));}
\DoxyCodeLine{01097\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01098\ \ \ \ \ \ \ \ \ V(0,k)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(-\/1);}
\DoxyCodeLine{01099\ \ \ \ \ \ \ \ \ V.col(k).normalize();}
\DoxyCodeLine{01100\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01101\ \ \ \ \ \}}
\DoxyCodeLine{01102\ \ \ \}}
\DoxyCodeLine{01103\ \ \ U.col(n)\ =\ VectorType::Unit(n+1,\ n);}
\DoxyCodeLine{01104\ \}}
\DoxyCodeLine{01105\ }
\DoxyCodeLine{01106\ }
...
\DoxyCodeLine{01111\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::deflation43(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ shift,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ i,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ size)}
\DoxyCodeLine{01112\ \{}
...
\DoxyCodeLine{01116\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ start\ =\ firstCol\ +\ shift;}
\DoxyCodeLine{01117\ \ \ RealScalar\ c\ =\ m\_computed(start,\ start);}
\DoxyCodeLine{01118\ \ \ RealScalar\ s\ =\ m\_computed(start+i,\ start);}
\DoxyCodeLine{01119\ \ \ RealScalar\ r\ =\ numext::hypot(c,s);}
\DoxyCodeLine{01120\ \ \ \textcolor{keywordflow}{if}\ (r\ ==\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))}
\DoxyCodeLine{01121\ \ \ \{}
\DoxyCodeLine{01122\ \ \ \ \ m\_computed(start+i,\ start+i)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{01123\ \ \ \ \ \textcolor{keywordflow}{return};}
\DoxyCodeLine{01124\ \ \ \}}
\DoxyCodeLine{01125\ \ \ m\_computed(start,start)\ =\ r;\ \ }
\DoxyCodeLine{01126\ \ \ m\_computed(start+i,\ start)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{01127\ \ \ m\_computed(start+i,\ start+i)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{01128\ \ \ }
\DoxyCodeLine{01129\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_jacobi_rotation}{JacobiRotation<RealScalar>}}\ J(c/r,-\/s/r);}
\DoxyCodeLine{01130\ \ \ \textcolor{keywordflow}{if}\ (m\_compU)\ \ m\_naiveU.middleRows(firstCol,\ size+1).applyOnTheRight(firstCol,\ firstCol+i,\ J);}
\DoxyCodeLine{01131\ \ \ \textcolor{keywordflow}{else}\ \ \ \ \ \ \ \ \ \ m\_naiveU.applyOnTheRight(firstCol,\ firstCol+i,\ J);}
...
\DoxyCodeLine{01140\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::deflation44(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstColu\ ,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstColm,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstRowW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstColW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ i,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ j,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ size)}
\DoxyCodeLine{01141\ \{}
...
\DoxyCodeLine{01146\ \ \ RealScalar\ c\ =\ m\_computed(firstColm+i,\ firstColm);}
\DoxyCodeLine{01147\ \ \ RealScalar\ s\ =\ m\_computed(firstColm+j,\ firstColm);}
\DoxyCodeLine{01148\ \ \ RealScalar\ r\ =\ sqrt(numext::abs2(c)\ +\ numext::abs2(s));}
\DoxyCodeLine{01149\ \textcolor{preprocessor}{\#ifdef\ \ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{01150\ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}deflation\ 4.4:\ "{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{},"{}}\ <<\ j\ <<\ \textcolor{stringliteral}{"{}\ -\/>\ "{}}\ <<\ c\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ <<\ s\ <<\ \textcolor{stringliteral}{"{}\ "{}}\ <<\ r\ <<\ \textcolor{stringliteral}{"{}\ ;\ "{}}}
\DoxyCodeLine{01151\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i-\/1,\ firstColm)\ \ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01152\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i,\ firstColm)\ \ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01153\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i+1,\ firstColm)\ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01154\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i+2,\ firstColm)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01155\ \ \ std::cout\ <<\ m\_computed(firstColm\ +\ i-\/1,\ firstColm\ +\ i-\/1)\ \ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01156\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i,\ firstColm+i)\ \ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01157\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i+1,\ firstColm+i+1)\ <<\ \textcolor{stringliteral}{"{}\ "{}}}
\DoxyCodeLine{01158\ \ \ \ \ <<\ m\_computed(firstColm\ +\ i+2,\ firstColm+i+2)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01159\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01160\ \ \ \textcolor{keywordflow}{if}\ (r==\doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0))}
\DoxyCodeLine{01161\ \ \ \{}
\DoxyCodeLine{01162\ \ \ \ \ m\_computed(firstColm\ +\ i,\ firstColm\ +\ i)\ =\ m\_computed(firstColm\ +\ j,\ firstColm\ +\ j);}
\DoxyCodeLine{01163\ \ \ \ \ \textcolor{keywordflow}{return};}
\DoxyCodeLine{01164\ \ \ \}}
\DoxyCodeLine{01165\ \ \ c/=r;}
\DoxyCodeLine{01166\ \ \ s/=r;}
\DoxyCodeLine{01167\ \ \ m\_computed(firstColm\ +\ i,\ firstColm)\ =\ r;}
\DoxyCodeLine{01168\ \ \ m\_computed(firstColm\ +\ j,\ firstColm\ +\ j)\ =\ m\_computed(firstColm\ +\ i,\ firstColm\ +\ i);}
\DoxyCodeLine{01169\ \ \ m\_computed(firstColm\ +\ j,\ firstColm)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{01170\ }
\DoxyCodeLine{01171\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_jacobi_rotation}{JacobiRotation<RealScalar>}}\ J(c,-\/s);}
\DoxyCodeLine{01172\ \ \ \textcolor{keywordflow}{if}\ (m\_compU)\ \ m\_naiveU.middleRows(firstColu,\ size+1).applyOnTheRight(firstColu\ +\ i,\ firstColu\ +\ j,\ J);}
\DoxyCodeLine{01173\ \ \ \textcolor{keywordflow}{else}\ \ \ \ \ \ \ \ \ \ m\_naiveU.applyOnTheRight(firstColu+i,\ firstColu+j,\ J);}
\DoxyCodeLine{01174\ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ \ m\_naiveV.middleRows(firstRowW,\ size).applyOnTheRight(firstColW\ +\ i,\ firstColW\ +\ j,\ J);}
...
\DoxyCodeLine{01180\ \textcolor{keywordtype}{void}\ BDCSVD<MatrixType>::deflation(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ lastCol,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ k,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstRowW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ firstColW,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Eigen::Index}}\ shift)}
\DoxyCodeLine{01181\ \{}
\DoxyCodeLine{01182\ \ \ \textcolor{keyword}{using\ }std::sqrt;}
\DoxyCodeLine{01183\ \ \ \textcolor{keyword}{using\ }std::abs;}
\DoxyCodeLine{01184\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ length\ =\ lastCol\ +\ 1\ -\/\ firstCol;}
\DoxyCodeLine{01185\ \ \ }
\DoxyCodeLine{01186\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_block}{Block<MatrixXr,Dynamic,1>}}\ col0(m\_computed,\ firstCol+shift,\ firstCol+shift,\ length,\ 1);}
\DoxyCodeLine{01187\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_diagonal}{Diagonal<MatrixXr>}}\ fulldiag(m\_computed);}
\DoxyCodeLine{01188\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_vector_block}{VectorBlock<Diagonal<MatrixXr>}},\doxymbox{\hyperlink{namespace_eigen_ad81fa7195215a0ce30017dfac309f0b2}{Dynamic}}>\ diag(fulldiag,\ firstCol+shift,\ length);}
\DoxyCodeLine{01189\ \ \ }
\DoxyCodeLine{01190\ \ \ \textcolor{keyword}{const}\ RealScalar\ considerZero\ =\ (std::numeric\_limits<RealScalar>::min)();}
\DoxyCodeLine{01191\ \ \ RealScalar\ maxDiag\ =\ diag.tail((std::max)(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}(1),length-\/1)).cwiseAbs().maxCoeff();}
\DoxyCodeLine{01192\ \ \ RealScalar\ epsilon\_strict\ =\ numext::maxi<RealScalar>(considerZero,NumTraits<RealScalar>::epsilon()\ *\ maxDiag);}
\DoxyCodeLine{01193\ \ \ RealScalar\ epsilon\_coarse\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(8)\ *\ NumTraits<RealScalar>::epsilon()\ *\ numext::maxi<RealScalar>(col0.cwiseAbs().maxCoeff(),\ maxDiag);}
\DoxyCodeLine{01194\ \ \ }
...
\DoxyCodeLine{01215\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=1;i<length;++i)}
\DoxyCodeLine{01216\ \ \ \ \ \textcolor{keywordflow}{if}\ (abs(col0(i))\ <\ epsilon\_strict)}
\DoxyCodeLine{01217\ \ \ \ \ \{}
\DoxyCodeLine{01218\ \textcolor{preprocessor}{\#ifdef\ \ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{01219\ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}deflation\ 4.2,\ set\ z("{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{})\ to\ zero\ because\ "{}}\ <<\ abs(col0(i))\ <<\ \textcolor{stringliteral}{"{}\ <\ "{}}\ <<\ epsilon\_strict\ <<\ \textcolor{stringliteral}{"{}\ \ (diag("{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{})="{}}\ <<\ diag(i)\ <<\ \textcolor{stringliteral}{"{})\(\backslash\)n"{}};}
\DoxyCodeLine{01220\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01221\ \ \ \ \ \ \ col0(i)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{Literal}}(0);}
\DoxyCodeLine{01222\ \ \ \ \ \}}
\DoxyCodeLine{01223\ }
\DoxyCodeLine{01224\ \ \ \textcolor{comment}{//condition\ 4.3}}
\DoxyCodeLine{01225\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=1;i<length;\ i++)}
\DoxyCodeLine{01226\ \ \ \ \ \textcolor{keywordflow}{if}\ (diag(i)\ <\ epsilon\_coarse)}
\DoxyCodeLine{01227\ \ \ \ \ \{}
\DoxyCodeLine{01228\ \textcolor{preprocessor}{\#ifdef\ \ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{01229\ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}deflation\ 4.3,\ cancel\ z("{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{})="{}}\ <<\ col0(i)\ <<\ \textcolor{stringliteral}{"{}\ because\ diag("{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{})="{}}\ <<\ diag(i)\ <<\ \textcolor{stringliteral}{"{}\ <\ "{}}\ <<\ epsilon\_coarse\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01230\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01231\ \ \ \ \ \ \ deflation43(firstCol,\ shift,\ i,\ length);}
\DoxyCodeLine{01232\ \ \ \ \ \}}
\DoxyCodeLine{01233\ }
...
\DoxyCodeLine{01246\ \ \ \ \ \textcolor{keywordtype}{bool}\ total\_deflation\ =\ (col0.tail(length-\/1).\doxymbox{\hyperlink{namespacedetail_a917c3efabea8a20dc72d9ae2c673d632af1f713c9e000f5d3f280adbd124df4f5}{array}}()<considerZero).all();}
\DoxyCodeLine{01247\ \ \ \ \ }
...
\DoxyCodeLine{01250\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ *permutation\ =\ m\_workspaceI.data();}
\DoxyCodeLine{01251\ \ \ \ \ \{}
\DoxyCodeLine{01252\ \ \ \ \ \ \ permutation[0]\ =\ 0;}
\DoxyCodeLine{01253\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ p\ =\ 1;}
\DoxyCodeLine{01254\ \ \ \ \ \ \ }
\DoxyCodeLine{01255\ \ \ \ \ \ \ \textcolor{comment}{//\ Move\ deflated\ diagonal\ entries\ at\ the\ end.}}
\DoxyCodeLine{01256\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=1;\ i<length;\ ++i)}
\DoxyCodeLine{01257\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(abs(diag(i))<considerZero)}
\DoxyCodeLine{01258\ \ \ \ \ \ \ \ \ \ \ permutation[p++]\ =\ i;}
\DoxyCodeLine{01259\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01260\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=1,\ j=k+1;}
\DoxyCodeLine{01261\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\ ;\ p\ <\ length;\ ++p)}
\DoxyCodeLine{01262\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01263\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (i\ >\ k)\ \ \ \ \ \ \ \ \ \ \ \ \ permutation[p]\ =\ j++;}
\DoxyCodeLine{01264\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (j\ >=\ length)\ \ \ \ \ \ \ permutation[p]\ =\ i++;}
\DoxyCodeLine{01265\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (diag(i)\ <\ diag(j))\ permutation[p]\ =\ j++;}
\DoxyCodeLine{01266\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ permutation[p]\ =\ i++;}
\DoxyCodeLine{01267\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01268\ \ \ \ \ \}}
\DoxyCodeLine{01269\ \ \ \ \ }
...
\DoxyCodeLine{01272\ \ \ \ \ \{}
\DoxyCodeLine{01273\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i=1;\ i<length;\ ++i)}
\DoxyCodeLine{01274\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01275\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pi\ =\ permutation[i];}
\DoxyCodeLine{01276\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(abs(diag(pi))<considerZero\ ||\ diag(0)<diag(pi))}
\DoxyCodeLine{01277\ \ \ \ \ \ \ \ \ \ \ permutation[i-\/1]\ =\ permutation[i];}
\DoxyCodeLine{01278\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{01279\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{01280\ \ \ \ \ \ \ \ \ \ \ permutation[i-\/1]\ =\ 0;}
...
\DoxyCodeLine{01287\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ *realInd\ =\ m\_workspaceI.data()+length;}
\DoxyCodeLine{01288\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ *realCol\ =\ m\_workspaceI.data()+2*length;}
\DoxyCodeLine{01289\ \ \ \ \ }
...
\DoxyCodeLine{01294\ \ \ \ \ \}}
\DoxyCodeLine{01295\ \ \ \ \ }
\DoxyCodeLine{01296\ \ \ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ total\_deflation?0:1;\ i\ <\ length;\ i++)}
\DoxyCodeLine{01297\ \ \ \ \ \{}
\DoxyCodeLine{01298\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pi\ =\ permutation[length\ -\/\ (total\_deflation\ ?\ i+1\ :\ i)];}
\DoxyCodeLine{01299\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ J\ =\ realCol[pi];}
\DoxyCodeLine{01300\ \ \ \ \ \ \ }
...
\DoxyCodeLine{01303\ \ \ \ \ \ \ swap(diag(i),\ diag(J));}
\DoxyCodeLine{01304\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(i!=0\ \&\&\ J!=0)\ swap(col0(i),\ col0(J));}
\DoxyCodeLine{01305\ }
\DoxyCodeLine{01306\ \ \ \ \ \ \ \textcolor{comment}{//\ change\ columns}}
\DoxyCodeLine{01307\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_compU)\ m\_naiveU.col(firstCol+i).segment(firstCol,\ length\ +\ 1).swap(m\_naiveU.col(firstCol+J).segment(firstCol,\ length\ +\ 1));}
\DoxyCodeLine{01308\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \ \ \ \ \ \ \ \ m\_naiveU.col(firstCol+i).segment(0,\ 2)\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ .swap(m\_naiveU.col(firstCol+J).segment(0,\ 2));}
\DoxyCodeLine{01309\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_compV)\ m\_naiveV.col(firstColW\ +\ i).segment(firstRowW,\ length).swap(m\_naiveV.col(firstColW\ +\ J).segment(firstRowW,\ length));}
\DoxyCodeLine{01310\ }
\DoxyCodeLine{01311\ \ \ \ \ \ \ \textcolor{comment}{//update\ real\ pos}}
\DoxyCodeLine{01312\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ realI\ =\ realInd[i];}
\DoxyCodeLine{01313\ \ \ \ \ \ \ realCol[realI]\ =\ J;}
\DoxyCodeLine{01314\ \ \ \ \ \ \ realCol[pi]\ =\ i;}
\DoxyCodeLine{01315\ \ \ \ \ \ \ realInd[J]\ =\ realI;}
\DoxyCodeLine{01316\ \ \ \ \ \ \ realInd[i]\ =\ pi;}
\DoxyCodeLine{01317\ \ \ \ \ \}}
\DoxyCodeLine{01318\ \ \ \}}
...
\DoxyCodeLine{01325\ \ \ \{}
\DoxyCodeLine{01326\ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ length-\/1;}
\DoxyCodeLine{01327\ \ \ \ \ \textcolor{keywordflow}{while}(i>0\ \&\&\ (abs(diag(i))<considerZero\ ||\ abs(col0(i))<considerZero))\ -\/-\/i;}
\DoxyCodeLine{01328\ \ \ \ \ \textcolor{keywordflow}{for}(;\ i>1;-\/-\/i)}
\DoxyCodeLine{01329\ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ (diag(i)\ -\/\ diag(i-\/1))\ <\ NumTraits<RealScalar>::epsilon()*maxDiag\ )}
\DoxyCodeLine{01330\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01331\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_DEBUG\_VERBOSE}}
\DoxyCodeLine{01332\ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}deflation\ 4.4\ with\ i\ =\ "{}}\ <<\ i\ <<\ \textcolor{stringliteral}{"{}\ because\ "{}}\ <<\ diag(i)\ <<\ \textcolor{stringliteral}{"{}\ -\/\ "{}}\ <<\ diag(i-\/1)\ <<\ \textcolor{stringliteral}{"{}\ ==\ "{}}\ <<\ (diag(i)\ -\/\ diag(i-\/1))\ <<\ \textcolor{stringliteral}{"{}\ <\ "{}}\ <<\ NumTraits<RealScalar>::epsilon()*\textcolor{comment}{/*diag(i)*/}maxDiag\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{01333\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01334\ \ \ \ \ \ \ \ \ eigen\_internal\_assert(abs(diag(i)\ -\/\ diag(i-\/1))<epsilon\_coarse\ \&\&\ \textcolor{stringliteral}{"{}\ diagonal\ entries\ are\ not\ properly\ sorted"{}});}
\DoxyCodeLine{01335\ \ \ \ \ \ \ \ \ deflation44(firstCol,\ firstCol\ +\ shift,\ firstRowW,\ firstColW,\ i-\/1,\ i,\ length);}
\DoxyCodeLine{01336\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01337\ \ \ \}}
\DoxyCodeLine{01338\ \ \ }
\DoxyCodeLine{01339\ \textcolor{preprocessor}{\#ifdef\ EIGEN\_BDCSVD\_SANITY\_CHECKS}}
\DoxyCodeLine{01340\ \ \ \textcolor{keywordflow}{for}(\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=2;j<length;++j)}
\DoxyCodeLine{01341\ \ \ \ \ assert(diag(j-\/1)<=diag(j)\ ||\ abs(diag(j))<considerZero);}
...
\DoxyCodeLine{01358\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d}{BDCSVD<typename\ MatrixBase<Derived>::PlainObject}}>}
\DoxyCodeLine{01359\ \doxymbox{\hyperlink{class_eigen_1_1_matrix_base_ae171b74b5d530846ee0836135ffcf837}{MatrixBase<Derived>::bdcSvd}}(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{int}\ computationOptions)\textcolor{keyword}{\ const}}
\DoxyCodeLine{01360\ \textcolor{keyword}{}\{}
\DoxyCodeLine{01361\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{class_eigen_1_1_b_d_c_s_v_d}{BDCSVD<PlainObject>}}(*\textcolor{keyword}{this},\ computationOptions);}
\DoxyCodeLine{01362\ \}}
\DoxyCodeLine{01363\ }
