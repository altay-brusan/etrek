\doxysection{os.\+h}
\hypertarget{vtk_2include_2vtk-9_85_2vtkfmt_2vtkfmt_2os_8h_source}{}\label{vtk_2include_2vtk-9_85_2vtkfmt_2vtkfmt_2os_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkfmt/vtkfmt/os.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkfmt/vtkfmt/os.h}}
...
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00095\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classbasic__cstring__view}{basic\_cstring\_view}}\ \{}
...
\DoxyCodeLine{00101\ \ \ \doxymbox{\hyperlink{classbasic__cstring__view_ab464b2378652892cec4716d3e3d475c7}{basic\_cstring\_view}}(\textcolor{keyword}{const}\ Char*\ s)\ :\ data\_(s)\ \{\}}
\DoxyCodeLine{00102\ }
\DoxyCodeLine{00104\ \ \ \doxymbox{\hyperlink{classbasic__cstring__view_a10b92cc0e3e67789601984099b9ed339}{basic\_cstring\_view}}(\textcolor{keyword}{const}\ std::basic\_string<Char>\&\ s)\ :\ data\_(s.\doxymbox{\hyperlink{classbasic__cstring__view_afee1380c4722894a55b8b6895f6bf255}{c\_str}}())\ \{\}}
\DoxyCodeLine{00105\ }
\DoxyCodeLine{00107\ \ \ \textcolor{keyword}{auto}\ \doxymbox{\hyperlink{classbasic__cstring__view_afee1380c4722894a55b8b6895f6bf255}{c\_str}}()\ const\ -\/>\ const\ Char*\ \{\ \textcolor{keywordflow}{return}\ data\_;\ \}}
\DoxyCodeLine{00108\ \};}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ \textcolor{keyword}{using\ }cstring\_view\ =\ \doxymbox{\hyperlink{classbasic__cstring__view}{basic\_cstring\_view<char>}};}
\DoxyCodeLine{00111\ \textcolor{keyword}{using\ }wcstring\_view\ =\ \doxymbox{\hyperlink{classbasic__cstring__view}{basic\_cstring\_view<wchar\_t>}};}
\DoxyCodeLine{00112\ }
...
\DoxyCodeLine{00115\ }
\DoxyCodeLine{00116\ namespace\ \doxymbox{\hyperlink{namespacedetail}{detail}}\ \{}
\DoxyCodeLine{00117\ FMT\_API\ \textcolor{keywordtype}{void}\ format\_windows\_error(buffer<char>\&\ out,\ \textcolor{keywordtype}{int}\ \doxymbox{\hyperlink{classerror__code}{error\_code}},}
\DoxyCodeLine{00118\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ message)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00119\ \}}
\DoxyCodeLine{00120\ }
\DoxyCodeLine{00121\ FMT\_API\ std::system\_error\ vwindows\_error(\textcolor{keywordtype}{int}\ \doxymbox{\hyperlink{classerror__code}{error\_code}},\ string\_view\ fmt,}
\DoxyCodeLine{00122\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{structformat__args}{format\_args}}\ args);}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00149\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00150\ \textcolor{keyword}{auto}\ windows\_error(\textcolor{keywordtype}{int}\ \doxymbox{\hyperlink{classerror__code}{error\_code}},\ string\_view\ message,\ \textcolor{keyword}{const}\ T\&...\ args)}
\DoxyCodeLine{00151\ \ \ \ \ -\/>\ std::system\_error\ \{}
\DoxyCodeLine{00152\ \ \ \textcolor{keywordflow}{return}\ vwindows\_error(\doxymbox{\hyperlink{classerror__code}{error\_code}},\ message,\ vargs<T...>\{\{args...\}\});}
\DoxyCodeLine{00153\ \}}
\DoxyCodeLine{00154\ }
...
\DoxyCodeLine{00157\ FMT\_API\ \textcolor{keywordtype}{void}\ report\_windows\_error(\textcolor{keywordtype}{int}\ \doxymbox{\hyperlink{classerror__code}{error\_code}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ message)\ \textcolor{keyword}{noexcept};}
...
\DoxyCodeLine{00167\ \textcolor{keywordtype}{void}\ say(\textcolor{keyword}{const}\ S\&\ fmt,\ Args\&\&...\ args)\ \{}
...
\DoxyCodeLine{00173\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classbuffered__file}{buffered\_file}}\ \{}
...
\DoxyCodeLine{00186\ \ \ \textcolor{keyword}{inline}\ buffered\_file()\ noexcept\ :\ file\_(\textcolor{keywordtype}{nullptr})\ \{\}}
\DoxyCodeLine{00187\ }
\DoxyCodeLine{00188\ \ \ \textcolor{comment}{//\ Destroys\ the\ object\ closing\ the\ file\ it\ represents\ if\ any.}}
\DoxyCodeLine{00189\ \ \ FMT\_API\ \string~buffered\_file()\ noexcept;}
\DoxyCodeLine{00190\ }
...
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ get()\ const\ noexcept\ -\/>\ FILE*\ \{\ \textcolor{keywordflow}{return}\ file\_;\ \}}
\DoxyCodeLine{00211\ }
\DoxyCodeLine{00212\ \ \ FMT\_API\ \textcolor{keyword}{auto}\ descriptor()\ const\ -\/>\ \textcolor{keywordtype}{int};}
\DoxyCodeLine{00213\ }
\DoxyCodeLine{00214\ \ \ template\ <typename...\ T>}
\DoxyCodeLine{00215\ \ \ inline\ \textcolor{keywordtype}{void}\ print(string\_view\ fmt,\ const\ T\&...\ args)\ \{}
...
\DoxyCodeLine{00364\ }
\DoxyCodeLine{00367\ \textcolor{keyword}{class\ }FMT\_API\ ostream\ :\ \textcolor{keyword}{private}\ \doxymbox{\hyperlink{classdetail_1_1buffer}{detail::buffer}}<char>\ \{}
\DoxyCodeLine{00368\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00369\ \ \ file\ file\_;}
\DoxyCodeLine{00370\ }
\DoxyCodeLine{00371\ \ \ ostream(cstring\_view\ path,\ \textcolor{keyword}{const}\ detail::ostream\_params\&\ params);}
\DoxyCodeLine{00372\ }
...
\DoxyCodeLine{00385\ \ \ \ \ \textcolor{keywordflow}{if}\ (size()\ ==\ 0)\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00386\ \ \ \ \ file\_.write(data(),\ size()\ *\ \textcolor{keyword}{sizeof}(data()[0]));}
