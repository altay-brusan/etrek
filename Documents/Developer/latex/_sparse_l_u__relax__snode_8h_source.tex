...
\hypertarget{_sparse_l_u__relax__snode_8h_source}{}\label{_sparse_l_u__relax__snode_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_relax\_snode.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_relax\_snode.h}}
...
\DoxyCodeLine{00047\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_a33672df380f94e774c5a6919d3474af4}{SparseLUImpl<Scalar,StorageIndex>::relax\_snode}}\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n,\ IndexVector\&\ et,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ relax\_columns,\ IndexVector\&\ descendants,\ IndexVector\&\ relax\_end)}
\DoxyCodeLine{00048\ \{}
\DoxyCodeLine{00049\ \ \ }
\DoxyCodeLine{00050\ \ \ \textcolor{comment}{//\ compute\ the\ number\ of\ descendants\ of\ each\ node\ in\ the\ etree}}
\DoxyCodeLine{00051\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ parent;\ }
\DoxyCodeLine{00052\ \ \ relax\_end.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(emptyIdxLU);}
\DoxyCodeLine{00053\ \ \ descendants.\doxymbox{\hyperlink{class_eigen_1_1_plain_object_base_ac21ad5f989f320e46958b75ac8d9a1da}{setZero}}();}
\DoxyCodeLine{00054\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ j\ <\ n;\ j++)\ }
\DoxyCodeLine{00055\ \ \ \{}
...
\DoxyCodeLine{00061\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ snode\_start;\ \textcolor{comment}{//\ beginning\ of\ a\ snode\ }}
\DoxyCodeLine{00062\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ j\ <\ n;\ )}
\DoxyCodeLine{00063\ \ \ \{}
...
\DoxyCodeLine{00072\ \ \ \ \ relax\_end(snode\_start)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(j);\ \textcolor{comment}{//\ Record\ last\ column}}
