...
\hypertarget{_sparse_dot_8h_source}{}\label{_sparse_dot_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseCore/SparseDot.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseCore/SparseDot.h}}
...
\DoxyCodeLine{00017\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{internal::traits<Derived>::Scalar}}}
\DoxyCodeLine{00018\ SparseMatrixBase<Derived>::dot(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_matrix_base}{MatrixBase<OtherDerived>}}\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>}}\ thisEval(derived());}
\DoxyCodeLine{00030\ \ \ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>::InnerIterator}}\ i(thisEval,\ 0);}
\DoxyCodeLine{00031\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_product}{Scalar}}\ res(0);}
...
\DoxyCodeLine{00042\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{internal::traits<Derived>::Scalar}}}
\DoxyCodeLine{00043\ SparseMatrixBase<Derived>::dot(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_eigen_1_1_sparse_matrix_base}{SparseMatrixBase<OtherDerived>}}\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00053\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>}}\ thisEval(derived());}
\DoxyCodeLine{00054\ \ \ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>::InnerIterator}}\ i(thisEval,\ 0);}
\DoxyCodeLine{00055\ \ \ }
\DoxyCodeLine{00056\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<OtherDerived>}}\ \ otherEval(other.derived());}
\DoxyCodeLine{00057\ \ \ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1evaluator}{internal::evaluator<OtherDerived>::InnerIterator}}\ j(otherEval,\ 0);}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \doxymbox{\hyperlink{class_eigen_1_1_product}{Scalar}}\ res(0);}
...
\DoxyCodeLine{00076\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
...
\DoxyCodeLine{00083\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
...
\DoxyCodeLine{00091\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{struct_eigen_1_1_num_traits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
