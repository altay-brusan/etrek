...
\hypertarget{_sparse_col_etree_8h_source}{}\label{_sparse_col_etree_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseCore/SparseColEtree.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseCore/SparseColEtree.h}}
...
\DoxyCodeLine{00040\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ etree\_find\ (\doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i,\ IndexVector\&\ pp)}
\DoxyCodeLine{00041\ \{}
\DoxyCodeLine{00042\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ p\ =\ pp(i);\ \textcolor{comment}{//\ Parent\ }}
\DoxyCodeLine{00043\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ gp\ =\ pp(p);\ \textcolor{comment}{//\ Grand\ parent\ }}
...
\DoxyCodeLine{00061\ \textcolor{keywordtype}{int}\ coletree(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{MatrixType}}\&\ mat,\ IndexVector\&\ parent,\ IndexVector\&\ firstRowElt,\ \textcolor{keyword}{typename}\ MatrixType::StorageIndex\ *perm=0)}
\DoxyCodeLine{00062\ \{}
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ MatrixType::StorageIndex\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00064\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ nc\ =\ convert\_index<StorageIndex>(mat.cols());\ \textcolor{comment}{//\ Number\ of\ columns}}
\DoxyCodeLine{00065\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ m\ =\ convert\_index<StorageIndex>(mat.rows());}
\DoxyCodeLine{00066\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ diagSize\ =\ (std::min)(nc,m);}
...
\DoxyCodeLine{00077\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ col\ =\ 0;\ col\ <\ nc;\ col++)}
\DoxyCodeLine{00078\ \ \ \{}
\DoxyCodeLine{00079\ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ pcol\ =\ col;}
...
\DoxyCodeLine{00082\ \ \ \ \ \{\ }
\DoxyCodeLine{00083\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ row\ =\ it.row();}
...
\DoxyCodeLine{00091\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ rset,\ cset,\ rroot;}
\DoxyCodeLine{00092\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ col\ =\ 0;\ col\ <\ nc;\ col++)\ }
\DoxyCodeLine{00093\ \ \ \{}
...
\DoxyCodeLine{00101\ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ pcol\ =\ col;}
...
\DoxyCodeLine{00105\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ col;}
...
\DoxyCodeLine{00108\ \ \ \ \ \ \ }
\DoxyCodeLine{00109\ \ \ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ row\ =\ firstRowElt(i);}
...
\DoxyCodeLine{00131\ \{}
\DoxyCodeLine{00132\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ IndexVector::Scalar\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00133\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ current\ =\ n,\ first,\ next;}
...
\DoxyCodeLine{00179\ \{}
\DoxyCodeLine{00180\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ IndexVector::Scalar\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00181\ \ \ IndexVector\ first\_kid,\ next\_kid;\ \textcolor{comment}{//\ Linked\ list\ of\ children\ }}
\DoxyCodeLine{00182\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ postnum;\ }
...
\DoxyCodeLine{00190\ \ \ \textcolor{keywordflow}{for}\ (\doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ v\ =\ n-\/1;\ v\ >=\ 0;\ v-\/-\/)\ }
\DoxyCodeLine{00191\ \ \ \{}
\DoxyCodeLine{00192\ \ \ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}\ dad\ =\ parent(v);}
