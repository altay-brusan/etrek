...
\hypertarget{_sparse_l_u__pivot_l_8h_source}{}\label{_sparse_l_u__pivot_l_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_pivotL.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/SparseLU/SparseLU\_pivotL.h}}
...
\DoxyCodeLine{00060\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1_sparse_l_u_impl_ab5f56947465b829f8d523575724c3ac6}{SparseLUImpl<Scalar,StorageIndex>::pivotL}}(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jcol,\ \textcolor{keyword}{const}\ RealScalar\&\ diagpivotthresh,\ IndexVector\&\ perm\_r,\ IndexVector\&\ iperm\_c,\ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\&\ pivrow,\ GlobalLU\_t\&\ glu)}
\DoxyCodeLine{00061\ \{}
\DoxyCodeLine{00062\ \ \ }
\DoxyCodeLine{00063\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ fsupc\ =\ (glu.xsup)((glu.supno)(jcol));\ \textcolor{comment}{//\ First\ column\ in\ the\ supernode\ containing\ the\ column\ jcol}}
\DoxyCodeLine{00064\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nsupc\ =\ jcol\ -\/\ fsupc;\ \textcolor{comment}{//\ Number\ of\ columns\ in\ the\ supernode\ portion,\ excluding\ jcol;\ nsupc\ >=0}}
\DoxyCodeLine{00065\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lptr\ =\ glu.xlsub(fsupc);\ \textcolor{comment}{//\ pointer\ to\ the\ starting\ location\ of\ the\ row\ subscripts\ for\ this\ supernode\ portion}}
\DoxyCodeLine{00066\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nsupr\ =\ glu.xlsub(fsupc+1)\ -\/\ lptr;\ \textcolor{comment}{//\ Number\ of\ rows\ in\ the\ supernode}}
\DoxyCodeLine{00067\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lda\ =\ glu.xlusup(fsupc+1)\ -\/\ glu.xlusup(fsupc);\ \textcolor{comment}{//\ leading\ dimension}}
\DoxyCodeLine{00068\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}*\ lu\_sup\_ptr\ =\ \&(glu.lusup.data()[glu.xlusup(fsupc)]);\ \textcolor{comment}{//\ Start\ of\ the\ current\ supernode}}
\DoxyCodeLine{00069\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}*\ lu\_col\_ptr\ =\ \&(glu.lusup.data()[glu.xlusup(jcol)]);\ \textcolor{comment}{//\ Start\ of\ jcol\ in\ the\ supernode}}
\DoxyCodeLine{00070\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}*\ lsub\_ptr\ =\ \&(glu.lsub.data()[lptr]);\ \textcolor{comment}{//\ Start\ of\ row\ indices\ of\ the\ supernode}}
\DoxyCodeLine{00071\ \ \ }
\DoxyCodeLine{00072\ \ \ \textcolor{comment}{//\ Determine\ the\ largest\ abs\ numerical\ value\ for\ partial\ pivoting\ }}
\DoxyCodeLine{00073\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ diagind\ =\ iperm\_c(jcol);\ \textcolor{comment}{//\ diagonal\ index\ }}
\DoxyCodeLine{00074\ \ \ RealScalar\ pivmax(-\/1.0);}
\DoxyCodeLine{00075\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pivptr\ =\ nsupc;\ }
\DoxyCodeLine{00076\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ diag\ =\ emptyIdxLU;\ }
\DoxyCodeLine{00077\ \ \ RealScalar\ rtemp;}
\DoxyCodeLine{00078\ \ \ \doxymbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ isub,\ icol,\ itemp,\ k;\ }
...
\DoxyCodeLine{00093\ \ \ \ \ perm\_r(pivrow)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(jcol);}
...
\DoxyCodeLine{00114\ \ \ perm\_r(pivrow)\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{StorageIndex}}(jcol);}
...
\DoxyCodeLine{00128\ \ \ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}\ temp\ =\ \doxymbox{\hyperlink{struct_eigen_1_1internal_1_1traits}{Scalar}}(1.0)\ /\ lu\_col\_ptr[nsupc];}
