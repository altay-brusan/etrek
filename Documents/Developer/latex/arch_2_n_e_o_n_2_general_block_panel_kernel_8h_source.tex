...
\hypertarget{arch_2_n_e_o_n_2_general_block_panel_kernel_8h_source}{}\label{arch_2_n_e_o_n_2_general_block_panel_kernel_8h_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/arch/NEON/GeneralBlockPanelKernel.h@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtkeigen/eigen/src/Core/arch/NEON/GeneralBlockPanelKernel.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_eigen}{Eigen}}\ \{}
...
\DoxyCodeLine{00010\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}\ <float,float,false,false,Architecture::NEON,GEBPPacketFull>}
\DoxyCodeLine{00011\ \ :\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}<float,float,false,false,Architecture::Generic,GEBPPacketFull>}
\DoxyCodeLine{00012\ \{}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}\ <float,float,false,false,Architecture::NEON,GEBPPacketFull>}
\DoxyCodeLine{00046\ \ :\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}<float,float,false,false,Architecture::Generic,GEBPPacketFull>}
\DoxyCodeLine{00047\ \{}
...
\DoxyCodeLine{00110\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}\ <double,double,false,false,Architecture::NEON>}
\DoxyCodeLine{00111\ \ :\ \doxymbox{\hyperlink{class_eigen_1_1internal_1_1gebp__traits}{gebp\_traits}}<double,double,false,false,Architecture::Generic>}
\DoxyCodeLine{00112\ \{}
