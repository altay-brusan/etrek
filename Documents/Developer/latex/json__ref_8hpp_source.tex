...
\hypertarget{json__ref_8hpp_source}{}\label{json__ref_8hpp_source}\index{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtknlohmannjson/include/vtknlohmann/detail/json\_ref.hpp@{C:/Users/altay/OneDrive/Projects/etrek/ThirdPartyLibraries/vtk/include/vtk-\/9.5/vtknlohmannjson/include/vtknlohmann/detail/json\_ref.hpp}}
...
\DoxyCodeLine{00013\ }
\DoxyCodeLine{00014\ \textcolor{preprocessor}{\#include\ VTK\_NLOHMANN\_JSON(detail/abi\_macros.hpp)}}
\DoxyCodeLine{00015\ \textcolor{preprocessor}{\#include\ VTK\_NLOHMANN\_JSON(detail/meta/type\_traits.hpp)}}
\DoxyCodeLine{00016\ }
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \ \ \ \ json\_ref(value\_type\&\&\ \doxymbox{\hyperlink{classdetail_1_1value}{value}})}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ :\ owned\_value(std::move(\doxymbox{\hyperlink{classdetail_1_1value}{value}}))}
\DoxyCodeLine{00029\ \ \ \ \ \{\}}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \ \ \ \ json\_ref(\textcolor{keyword}{const}\ value\_type\&\ \doxymbox{\hyperlink{classdetail_1_1value}{value}})}
\DoxyCodeLine{00032\ \ \ \ \ \ \ \ \ :\ value\_ref(\&\doxymbox{\hyperlink{classdetail_1_1value}{value}})}
\DoxyCodeLine{00033\ \ \ \ \ \{\}}
\DoxyCodeLine{00034\ }
...
\DoxyCodeLine{00041\ \ \ \ \ \ \ \ \ enable\_if\_t<std::is\_constructible<value\_type,\ Args...>\doxymbox{\hyperlink{classdetail_1_1value}{::value}},\ \textcolor{keywordtype}{int}>\ =\ 0\ >}
